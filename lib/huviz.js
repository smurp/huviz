...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.animate_sparql_search = function(overMsec, fc, bc) {
      var elem;
      elem = this.endpoint_labels_JQElem[0];
      return this.animate_fill_graph(elem, overMsec, fc, bc);
    };

    Huviz.prototype.animate_fill_graph = function(elem, overMsec, fillColor, bgColor) {
      var animId, go, startMsec;
      if (overMsec == null) {
        overMsec = 2000;
      }
      if (fillColor == null) {
      ...
      go = function(elem, overMsec, fillColor, bgColor) {
        ...
        step = function(nowMsec) {
          var bg, bgPct, fillPct, progressMsec;
          if (!startMsec) {
            startMsec = nowMsec;
          }
        ...
        return animId = requestAnimationFrame(step);
      };
