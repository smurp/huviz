...
(function() {
  ...
  PickOrProvide = (function() {
    ...
    PickOrProvide.prototype.update_state = function() {
      var canDelete, disable_the_delete_button, raw_value, selected_option;
      ...
      return this.form.find('.delete_option').prop('disabled', disable_the_delete_button);
    };
