...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.init_settings_from_json = function() {
      var WidgetClass, control, controlElem, control_name, control_spec, event_type, graph_control, groupElem, groupName, input, inputElem, inputId, k, labelElem, old_val, opt, optIdx, optionElem, settings_input_sel, v, value, _i, _len, _ref, _ref1, _ref2, _ref3;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (control_name in control_spec) {
          ...
          input = false;
          if (false) {
            graph_control = d3.select(groupElem).append('div').attr('id', control_name).attr('class', 'a_setting');
          }
          ...
          if (control.input.type === 'select') {
            inputElem = this.insertBeforeEnd(controlElem, "<select name=\"" + control.name + "\"></select>");
    ...
    Huviz.prototype.on_change_graph_title_style = function(new_val, old_val) {
      ...
      if (new_val === "custom") {
        ...
        this.topJQElem.find("#graph_custom_main_title").css('display', 'inherit');
        this.topJQElem.find("#graph_custom_sub_title").css('display', 'inherit');
        ...
        this.topJQElem.find("#graph_custom_main_title").css('display', 'none');
        this.topJQElem.find("#graph_custom_sub_title").css('display', 'none');
