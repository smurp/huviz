...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.add_verb_set = function(vset) {
      var alternatives, id, label, _results;
      alternatives = this.verbdiv.append('div').attr('class', 'alternates');
      _results = [];
      for (id in vset) {
        label = vset[id];
        this.verb_pretty_name[id] = label;
        _results.push(this.build_verb_picker(id, label, alternatives));
      }
      return _results;
    };
        ...
        success: (function(_this) {
          return function(json, textStatus, request) {
            ...
            if (json.status) {
              ...
              if ((!_this.discover_geoname_name_msgs[msg]) || (Date.now() - _this.discover_geoname_name_msgs[msg] > _this.discover_geoname_name_msgs_threshold_ms)) {
