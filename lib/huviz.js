  ...
  Huviz = (function() {
    ...
    Huviz.prototype.load_endpoint_data_and_show = function(subject, callback) {
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(data, textStatus, jqXHR) {
            var disable, endpoint, json_check, json_data, node, _i, _len, _ref, _results;
            json_check = typeof data;
            if (json_check === 'string') {
              json_data = JSON.parse(data);
            } else {
            ...
            _this.after_file_loaded('sparql', callback);
            console.log("--------------Show me my node list------------");
            _ref = _this.shelved_set;
            _results = [];
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              node = _ref[_i];
              _results.push(console.log(node.pretty_name.NOLANG));
            }
            return _results;
          };
        })(this),
    ...
    Huviz.prototype.add_nodes_from_SPARQL = function(json_data, subject) {
      var context, count, data, language, node, node_list_empty, node_not_in_list, nodes_in_data, obj_type, obj_val, plainLiteral, pred, q, snode, subj, _i, _j, _len, _len1, _ref, _results;
      data = '';
      context = "http://universal.org";
      ...
      for (_i = 0, _len = nodes_in_data.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
          ...
          if (q.s === snode.s && q.p === snode.p && q.o.value === snode.o.value && q.o.type === snode.o.type && q.o.language === snode.o.language) {
            console.log("This one is already in the quad set: ");
