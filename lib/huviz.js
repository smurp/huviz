...
(function() {
  ...
  Huviz = (function() {
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(data, textStatus, jqXHR) {
            var endpoint_selector, graph, graph_options, graphsNotFound, json_check, json_data, results, _i, _len;
            console.log(data);
            console.log(jqXHR.getAllResponseHeaders(data));
            ...
            $(endpoint_selector).change(_this.update_endpoint_form);
            spinner.css('display', 'none');
            $("#endpoint_labels").prop('disabled', false).attr('value', '');
            $("#endpoint_limit").prop('disabled', false).attr('value', '100');
            $('#sparqlQryInput').css('color', 'inherit');
    ...
    Huviz.prototype.update_endpoint_form = function(e) {
      ...
      return $(graphSelector).change(this.update_graph_form);
    };
