...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.on_taxon_clicked = function(taxonId, new_state, elem) {
      var because, cmd, hasVerbs, old_state, taxon;
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.discover_geoname_name = function(aUrl) {
      ...
      if (this.discover_geonames_remaining == null) {
        this.discover_geonames_remaining = 1;
      }
      this.discover_geonames_remaining--;
      $.ajax({
