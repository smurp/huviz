...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.push_sparqlQuery_onto_log = function(qry, meta) {
      var id, qryJQElem, queriesJQElem;
      if (meta == null) {
        meta = {};
      }
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.auto_discover_name_for = function(uri) {
      var aUrl, e, expansion, handler, retval, sparql, _i, _len, _ref, _ref1, _ref2;
      if (uri.startsWith('_')) {
        return;
      }
      try {
    ...
    Huviz.prototype.log_query = function(qry) {
      this.gclui.push_sparqlQuery_onto_log(qry);
    ...
    Huviz.prototype.hilight_dialog = function(dialog_elem) {
      ...
      return console.info("TODO make hilight_dialog('" + dialog_id + "') bring it to top and do a CSS animation");
    };
    ...
    Huviz.prototype.animate_endpoint_label_search = function(overMsec, fc, bc) {
      ...
      fc = 'lightblue';
      elem = this.endpoint_labels_JQElem[0];
      return this.endpoint_label_search_anim = this.animate_fill_graph(elem, overMsec, fc, bc);
    };
    ...
    Huviz.prototype.populate_graphs_selector = function(request, response) {
      var ajax_settings, fromGraph, more, qry, spinner, url;
      ...
      this.log_query(qry);
      more = "&timeout=" + this.get_sparql_timeout_msec();
      ajax_settings = {
        'method': 'GET',
