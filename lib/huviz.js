...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.add_quad = function(quad) {
      var add_name, cntx_n, ctxid, edge, is_type, literal_node, make_edge, newsubj, objId, objKey, objVal, obj_n, pred_n, pred_uri, safe_quad_o_value, simpleType, subj, subj_lid, subj_n, subj_uri;
      subj_uri = quad.s;
      pred_uri = quad.p;
