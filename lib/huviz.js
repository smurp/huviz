    ...
    <div class="combined_command_history AKA_nextcommandbox AKA_history">
      <div class="commandlist shrunk inset_shadow AKA_cmdlist AKA_nextcommand">
        ...
        <div class="scriptPlayerControls">
          ...
          <button class="scriptDownloadJson" title="save script as .json" disabled=disabled>
...
of the classes indicated.`,
  ...
  make_command_history() {
    ...
    */
    ...
    this.scriptDownloadJsonButton = this.scriptPlayerControls.querySelector('.scriptDownloadJson');
    this.scriptDownloadButton.onclick = this.on_downloadscript_json_clicked;
...
`;
  ...
  init_resource_menus() {
    ...
    if (this.ontology_loader && this.ontology_loader.last_val) {
