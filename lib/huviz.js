...
(function() {
  var CommandController, QueryManager, getRandomId,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  ...
  QueryManager = (function() {
    ...
    QueryManager.prototype.setNoneColor = function() {
      this.styleQuery('#d3d3d357', 'result-none');
    };

    QueryManager.prototype.setErrorColor = function() {
      this.styleQuery('#f9e7ea', 'result-error');
    };

    QueryManager.prototype.setSuccessColor = function() {
      this.styleQuery('#e6f9e6', 'result-success');
    };
