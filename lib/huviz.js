...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.get_script_body_as_json = function() {
      var cmd, cmdList, elem_and_cmd, _i, _len, _ref;
      cmdList = [];
      _ref = this.command_list;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  ...
  GraphCommand = (function() {
    ...
    GraphCommand.prototype.update_str = function() {
      var cmd_str, like_str, maybe_every, missing, more, obj_phrase, ready, regarding_phrase, regarding_required, s, subj, verb, _i, _len, _ref;
