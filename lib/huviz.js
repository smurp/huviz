...
${this.make_copy_url_button(uri, "Just load this dataset:")}

${this.make_copy_url_button(scriptUri, "Play Script to Here:")}
`;
    this.make_dialog(md, null, args);
  }

  make_copy_url_button(uri, title) {
    ...
    return `<br>
            <span>${title}</span>
            <div id="shareLinkId" class="urlToShare">${uri}</div>
