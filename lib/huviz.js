...
(function(/*! Stitch !*/) {
  ...
  Edge = (function() {
    ...
    Edge.prototype.show = function() {
      this.predicate.shown_inst.acquire(this);
      if (this.isSelected()) {
        this.predicate.select(this);
      } else {
        this.predicate.unshown_inst.remove(this);
    ...
    Edge.prototype.unshow = function() {
      if (this.isSelected()) {
        this.predicate.unshown_inst.acquire(this);
        this.predicate.select(this);
      } else {
        this.predicate.unshown_inst.acquire(this);
        this.predicate.unselected_inst.acquire(this);
      }
      return this.predicate.update(this, {
        show: false
      });
...
(function() {
  ...
  Predicate = (function(_super) {
    ...
    function Predicate(id) {
      ...
      this.lid = this.id.match(/([\w\d\_\-]+)$/g)[0];
      this.shown_inst = SortedSet().sort_on("id").named("shown").isState("_s");
      this.unshown_inst = SortedSet().sort_on("id").named("unshown").isState("_s");
      this.selected_inst = SortedSet().sort_on("id").named("selected").isState('_p');
      this.unselected_inst = SortedSet().sort_on("id").named("unselected").isState('_p');
    ...
    Predicate.prototype.update = function(edge, change) {
      if (change.show != null) {
        if (change.show) {
          this.shown_inst.acquire(edge);
        } else {
          this.unshown_inst.acquire(edge);
        }
      }
      if (change.select != null) {
        if (change.select) {
          this.selected_inst.acquire(edge);
        } else {
          this.unselected_inst.acquire(edge);
        }
      }
    ...
    Predicate.prototype.update_selected_inst = function() {
      var before_count, e, _i, _len, _ref, _results;
      before_count = this.selected_inst.length;
      _ref = this.all_edges;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        e = _ref[_i];
        if (e.an_end_is_selected()) {
          _results.push(this.selected_inst.acquire(e));
        } else {
          _results.push(void 0);
        }
      }
    ...
    Predicate.prototype.recalc_direct_state = function() {
      if (this.selected_inst.length === 0) {
        return this.state = "hidden";
      } else if (this.only_some_selected_inst_are_shown()) {
        return this.state = "mixed";
      } else if (this.selected_inst.length > 0 && this.all_selected_inst_are_shown()) {
        return this.state = "showing";
      } else if (this.no_selected_inst_are_shown()) {
    ...
    Predicate.prototype.no_selected_inst_are_shown = function() {
      var e, _i, _len, _ref;
      _ref = this.selected_inst;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        e = _ref[_i];
        if (e.shown != null) {
          return false;
    ...
    Predicate.prototype.all_selected_inst_are_shown = function() {
      var e, _i, _len, _ref;
      _ref = this.selected_inst;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        e = _ref[_i];
    ...
    Predicate.prototype.only_some_selected_inst_are_shown = function() {
