...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.handle_on_taxon_clicked = function(id, new_state, elem, original_click) {
      if (original_click) {
        if (window.original_click == null) {
      ...
      return setTimeout((function(_this) {
        return function() {
          return _this.on_taxon_clicked(id, new_state, elem, original_click);
        };
      })(this));
    };
    ...
    CommandController.prototype.on_taxon_clicked = function(taxonId, new_state, elem, original_click) {
      var because, cmd, hasVerbs, old_state, skip_history, taxon;
      taxon = this.huviz.taxonomy[taxonId];
      hasVerbs = !!this.engaged_verbs.length;
      skip_history = !original_click;
      if (hasVerbs) {
        cmd = new gcl.GraphCommand(this.huviz, {
...
(function() {
  ...
  TreePicker = (function() {
    ...
    TreePicker.prototype.go_to_next_state = function(id, new_state) {
      var listener, original_click, send_leafward;
      listener = this.click_listener;
      send_leafward = this.id_is_collapsed[id];
      return this.effect_click(id, new_state, send_leafward, listener, (original_click = true));
    };

    TreePicker.prototype.effect_click = function(id, new_state, send_leafward, listener, original_click) {
      ...
      if (listener != null) {
        elem = this.id_to_elem[id];
        return listener.call(this, id, new_state, elem, original_click);
      }
    };
