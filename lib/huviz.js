...
(function() {
  ...
  Huviz = (function() {
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(data, textStatus, jqXHR) {
            ...
            return _this.disable_dataset_ontology_loader();
          };
        })(this),
        error: (function(_this) {
          return function(jqxhr, textStatus, errorThrown) {
    ...
    Huviz.prototype.visualize_dataset_using_ontology = function(ignoreEvent, dataset, ontologies) {
      var data, endpoint_uri, onto;
      this.close_blurt_box();
      endpoint_uri = $("#endpoint_labels").val();
      if (endpoint_uri) {
        this.load_endpoint_data_and_show(endpoint_uri);
        this.update_browser_title("TEST ENDPOINT");
        this.update_caption("TEST", "TEST");
        return;
      }
      ...
      return $("#endpoint_labels").autocomplete({
        ...
        source: function(request, response) {
          ...
          return $.ajax({
            ...
            error: (function(_this) {
              return function(jqxhr, textStatus, errorThrown) {
                return console.log(url, errorThrown);
              };
            })(this)
          });
        }
