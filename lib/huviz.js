...
(function() {
      ...
      if (reg_req) {
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          ...
          iter = (function(_this) {
            return function(node) {
              var retval;
              retval = meth.call(_this.huviz, node, _this);
              return _this.huviz.tick();
            };
          })(this);
          if (nodes != null) {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.get_resource_from_db = function(rsrcUri, callback) {
      ...
      trx.oncomplete = (function(_this) {
        return function(e) {
          return console.log("" + rsrcUri + " found");
        };
      })(this);
      trx.onerror = (function(_this) {
        return function(e) {
          console.log(e);
          return alert("get_resource_from_db(" + rsrcUri + ") error!!!");
        };
      })(this);
      store = trx.objectStore('datasets');
    ...
    Huviz.prototype.init_resource_menus = function() {
      ...
      if (!this.script_loader && this.args.script_loader__append_to_sel) {
        ...
        $("#" + this.script_loader.uniq_id).attr('style', 'display:none');
      }
    ...
    Huviz.prototype.visualize_dataset_using_ontology = function(ignoreEvent, dataset, ontologies) {
      var data, endpoint_label_uri, msg, onto, option, scriptUri;
    ...
    Huviz.prototype.load_script_from_db = function(rsrcRec) {
