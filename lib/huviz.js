...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.respect_single_chosen_node = function() {
      var chosen_node, cmd, dirty, pinned_node, _i, _len, _ref;
      dirty = false;
    ...
    Huviz.prototype.auto_discover_name_for = function(uri) {
      var aUrl, e, expansion, handler, log_prefix, retval, sparql, timeout, _i, _len, _ref, _ref1, _ref2;
      if (uri.startsWith('_')) {
        return;
      }
      try {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (uri.startsWith(expansion)) {
          _ref1 = this.make_sparql_name_query_and_handler(uri, expansion), sparql = _ref1[0], handler = _ref1[1];
          timeout = this.get_sparql_timeout_msec();
          this.log_query_with_timeout(log_prefix + sparql, timeout, 'purple');
        }
      }
      if (uri.startsWith("http://sws.geonames.org/") && ((_ref2 = this.discover_geonames_as__widget.state) === 'untried' || _ref2 === 'looking' || _ref2 === 'good') && this.discover_geonames_remaining > 0) {
        this.discover_geoname_name(aUrl);
      }
    };

    Huviz.prototype.ingest_quads_from_sparql = function(sparql) {
    ...
    Huviz.prototype.run_managed_query_abstract = function(qry, url, args) {
      ...
      return this.log_query_with_timeout(qry, args.timeout);
    };
    ...
    Huviz.prototype.get_neighbors_via_sparql = function(chosen) {
      var maxReq, msg;
    ...
    Huviz.prototype.unpin = function(node) {
      delete node.pinned_only_while_chosen;
      if (node.fixed) {
    ...
    Huviz.prototype.choose = function(chosen) {
      var shownness;
      if (this.is_from_sparql()) {
        this.get_neighbors_via_sparql(chosen);
      }
    ...
    Huviz.prototype.on_change_single_chosen = function(new_val, old_val) {
