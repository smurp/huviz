...
(function() {
  ...
  GraphCommand = (function() {
    ...
    GraphCommand.prototype.execute = function() {
      var USE_ASYNC, callback, errorHandler, iter, meth, node, nodes, reg_req, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
  ...
  Huviz = (function() {
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(data, textStatus, jqXHR) {
            var endpoint_selector, graph, graph_options, json_check, json_data, results, _i, _len;
            ...
            endpoint_selector = "#" + _this.endpoint_loader.select_id;
            return $(endpoint_selector).change(_this.update_endpoint_form);
          };
        })(this),
        error: (function(_this) {
          return function(jqxhr, textStatus, errorThrown) {
    ...
    Huviz.prototype.walk__build_callback = function(commandObj, nodes) {
      var oldChosen, unchooseTheseLater, _i, _len, _ref;
      unchooseTheseLater = [];
      _ref = commandObj.graph_ctrl.chosen_set;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        oldChosen = _ref[_i];
        if (!(__indexOf.call(nodes, oldChosen) >= 0)) {
      ...
      return (function(_this) {
        return function(err) {
          ...
          if (err != null) {
            ...
            _results = [];
            for (_j = 0, _len1 = unchooseTheseLater.length; _j < _len1; _j++) {
              oldChosen = unchooseTheseLater[_j];
              _results.push(commandObj.graph_ctrl.unchoose(oldChosen));
            }
            return _results;
          }
        };
    ...
    Huviz.prototype.update_endpoint_form = function(e) {
      ...
      return $(graphSelector).parent().css('display', 'block');
    };
    ...
    Huviz.prototype.populate_sparql_label_picker = function() {
      var fromGraph, searchHint, select_box, spinner;
      searchHint = "";
    ...
    function Huviz(args) {
      ...
      this.walk__build_callback = __bind(this.walk__build_callback, this);
