      ...
      if (url.startsWith('file:///') || url.indexOf('/') === -1) {
        this.get_resource_from_db(url, (function(_this) {
          return function(err, rsrcRec) {
            ...
            blurt(err || ("'" + url + " was not found in your DATASET menu.  Provide it and reload this page"));
      ...
      if (url.startsWith('file:///') || url.indexOf('/') === -1) {
        this.get_resource_from_db(url, (function(_this) {
          return function(err, rsrcRec) {
            ...
            blurt(err || ("'" + url + "' was not found in your ONTOLOGY menu.  Provide it and reload page"));
            _this.reset_dataset_ontology_loader();
          };
        })(this));
        return;
