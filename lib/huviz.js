...
(function() {
  ...
  var CommandController, DC_subject, DragAndDropLoader, Edge, EditController, FOAF_Group, FOAF_Person, FOAF_name, GraphCommandLanguageCtrl, GreenerTurtle, Huviz, IndexedDBService, IndexedDBStorageController, MANY_SPACES_REGEX, NAME_SYNS, Node, OWL_Class, OWL_ObjectProperty, OWL_Thing, OntoViz, OntologicallyGrounded, Orlando, PEEKING_COLOR, PickOrProvide, Predicate, RDFS_label, RDF_a, RDF_literal, RDF_object, RDF_type, Socrata, TYPE_SYNS, Taxon, TextCursor, UNDEFINED, XML_TAG_REGEX, angliciser, blurt, default_node_radius_policy, dist_lt, distance, escapeHtml, gcl, has_predicate_value, has_type, hpad, id_escape, ids_to_show, is_a_main_node, is_node_to_always_show, is_one_of, linearize, node_radius_policies, orlando_human_term, start_with_http, tau, themeStyles, unescape_unicode, unique_id, uniquer, wpad,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.add_quad = function(quad) {
      var add_name, cntx_n, ctxid, edge, is_type, newsubj, obj_n, pid, pred_n, sid, subj, subj_lid, subj_n;
      sid = quad.s;
    ...
    Huviz.prototype.parseAndShowTTLData = function(data, textStatus, callback) {
      ...
      console.log(this.ontology_loader);
    ...
    Huviz.prototype.fetchAndShow = function(url, callback) {
      ...
      if (url.match(/.ttl/)) {
        ...
        console.log(this.dataset_loader);
        return;
      }
    ...
    Huviz.prototype.ensure_dataset = function(dataset_rec, store_in_db) {
      ...
      if (this.dataset_loader) {
        return this.dataset_loader.add_dataset(dataset_rec, store_in_db);
      }
    };
    ...
    Huviz.prototype.init_dataset_menus = function() {
      ...
      console.log(this.dataset_loader);
      console.log(this.ontology_loader);
      console.log(this.args.dataset_loader__append_to_sel);
      console.log(this.args.ontology_loader__append_to_sel);
    ...
    Huviz.prototype.pick_parser_for_local_file = function(fname) {
      var the_parser;
      the_parser = this.parseAndShowNQ;
      if (fname.match(/.ttl/)) {
        the_parser = this.parseAndShowTTLData;
...
<<<<<<< HEAD
      ...
      if (this.local_file_data) {
        this.read_data_and_show(this.dataset_loader.value);
=======
      var selected_dataset, the_parser;
      this.set_ontology(this.ontology_loader.value);
      if (this.dataset_loader.the_file_contents != null) {
        the_parser = this.pick_parser_for_local_file(this.dataset_loader.value);
        the_parser(this.dataset_loader.the_file_contents, '');
>>>>>>> f1720925d10c14ea4dddc1260f9bd52eba93aaef
      } else {
        this.load_file_from_uri(this.dataset_loader.value);
      }
      selected_dataset = this.dataset_loader.get_selected_option()[0];
      this.update_browser_title(selected_dataset);
      return this.update_caption(this.dataset_loader.value, this.ontology_loader.value);
    };
    ...
    Huviz.prototype.disable_dataset_ontology_loader = function() {
      var disable;
      console.log("disable dataset ontology loader");
      this.dataset_loader.disable();
      this.ontology_loader.disable();
      this.replace_loader_display(this.dataset_loader.get_selected_option()[0].label, this.ontology_loader.get_selected_option()[0].label);
      disable = true;
    ...
    Huviz.prototype.replace_loader_display = function(selected_dataset, selected_ontology) {
    ...
    Huviz.prototype.update_browser_title = function(selected_dataset) {
      if (selected_dataset.value) {
        return document.title = selected_dataset.label + " - Huvis Graph Visualization";
      }
    };
    ...
    Huviz.prototype.set_ontology_from_dataset_if_possible = function() {
      ...
      console.log(this.ontology_loader.value);
      console.log(this.dataset_loader.value);
  ...
  PickOrProvide = (function() {
    ...
    PickOrProvide.prototype.add_local_file = function(file_rec) {
      ...
      console.log(this.huviz.local_file_data);
      data_type = "local";
    ...
    PickOrProvide.prototype.update_state = function(callback) {
      ...
      console.log("PickOrProvide:", "select:", this.pick_or_provide_select[0].value);
...
=======
            return _this.the_file_contents = evt.target.result;
>>>>>>> f1720925d10c14ea4dddc1260f9bd52eba93aaef
          } catch (_error) {
            e = _error;
            msg = e.toString();
