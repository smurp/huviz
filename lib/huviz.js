...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.turn_on_loading_notice = function() {
      var txt;
      this.disable_go_button();
      this.state_msg_box = $("" + this.args.state_msg_box_sel);
      console.log("loading");
      ...
      return colorlog('turn_on_loading_notice()', 'green');
    };

    Huviz.prototype.turn_off_loading_notice = function() {
      $("#state_loading_box").hide();
      return colorlog('turn_off_loading_notice()', 'green');
    };
