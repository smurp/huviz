  ...
  Huviz = (function() {
    ...
    Huviz.prototype.init_dataset_menus = function() {
      ...
      if (!this.endpoint_loader && this.args.endpoint_loader__append_to_sel) {
        ...
        console.log(this.endpoint_loader);
      }
    ...
    Huviz.prototype.populate_label_picker = function(labels) {
      ...
      select_box = "<div class=ui-widget>\n  <label for='endpoint_labels'>Find: </label>\n  <input id='endpoint_labels'>\n  <i class='fas fa-spinner fa-spin' style='visibility:hidden;margin-left: 5px;'></i>\n</div>";
      searchHint = "<br><p style='font-size:.8em;margin-top:-10px;color: #999;margin-left: 40px;'>Put a space in front to retrieve word</p>";
