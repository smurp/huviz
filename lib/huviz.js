...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.init_graph_controls_from_json = function() {
      var control, control_name, control_spec, input, k, label, selector_for_graph_controls, v, _i, _len, _ref, _results;
      selector_for_graph_controls = '#tabs-options';
      this.graph_controls = d3.select(selector_for_graph_controls);
      console.log("graph_controls", this.graph_controls);
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          for (control_name in control_spec) {
            ...
            label = this.graph_controls.append('label');
            ...
            _results1.push(input.attr("onchange", "HVZ.update_graph_settings(this)"));
          }
          return _results1;
        }).call(this));
      }
    ...
    TreePicker.prototype.show_tree = function(tree, i_am_in, listener, top) {
      ...
      for (node_id in tree) {
        ...
        contents_of_me.on('click', function() {
          ...
          console.log("WE ARE HERE <------------------------", picker.gclui != null);
          if (picker.gclui != null) {
