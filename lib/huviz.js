...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.hilight_dialog = function(dialog_elem_or_id) {
      var dialog_id;
      if (typeof dialog_elem_or_id === 'string') {
    ...
    Huviz.prototype.print_edge = function(edge) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (this.currently_printed_snippets[edge_inspector_id] != null) {
          this.hilight_dialog(edge_inspector_id);
          continue;
        }
        me = this;
  ...
  Orlando = (function(_super) {
    ...
    Orlando.prototype.push_snippet = function(msg_or_obj) {
      ...
      return this.make_dialog(msg_or_obj, obj.edge_inspector_id, dialogArgs);
    };

    Orlando.prototype.close_edge_inspector = function(event, ui) {
      var edge_inspector_id;
