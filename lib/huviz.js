  ...
  Huviz = (function() {
    ...
    Huviz.prototype.add_quad = function(quad) {
      ...
      if (quad.o.type === RDF_object) {
        ...
        if (quad.o.value === RDF_Class) {
          this.try_to_set_node_type(obj_n, safe_quad_o_value);
        }
