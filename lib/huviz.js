...
(function(/*! Stitch !*/) {
  ...
  EditController = (function() {
    function EditController(huviz) {
      var clearForm, con, saveForm, validateForm;
      this.huviz = huviz;
      this.clear_edit_form = __bind(this.clear_edit_form, this);
      this.userValid = true;
      if (this.userValid === true && document.getElementsByClassName("edit-controls")[0] === void 0) {
        ...
        this.create_edit_form(con);
        con.getElementsByClassName("slider")[0].onclick = this.toggle_edit_form;
        this.formFields = con.getElementsByTagName("form")[0];
    ...
    EditController.prototype.toggle_edit_form = function() {
      ...
      if (toggleEditMode === 'yes') {
        ...
        return toggleEdit.classList.remove("edit-mode");
      }
    };

    EditController.prototype.validate_edit_form = function() {
      var i, inputFields, saveButton, _i, _ref, _results;
      ...
      for (i = _i = 0, _ref = inputFields.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
        if (this.parentElement.elements[i].value === '') {
    ...
    EditController.prototype.save_edit_form = function() {
      var assrtSave, i, inputFields, quad, saveButton, tuple, _i, _ref;
      inputFields = this.parentElement.getElementsByTagName('input');
      tuple = [];
      for (i = _i = 0, _ref = inputFields.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
...
(function() {
  ...
  var CommandController, DC_subject, Edge, EditController, FOAF_Group, FOAF_Person, FOAF_name, GraphCommandLanguageCtrl, GreenerTurtle, Huviz, IndexedDBService, IndexedDBStorageController, LocalFileLoader, MANY_SPACES_REGEX, NAME_SYNS, Node, OWL_Class, OWL_ObjectProperty, OWL_Thing, OntoViz, OntologicallyGrounded, Orlando, PEEKING_COLOR, Predicate, RDFS_label, RDF_a, RDF_literal, RDF_object, RDF_type, Socrata, TYPE_SYNS, Taxon, TextCursor, UNDEFINED, XML_TAG_REGEX, angliciser, default_node_radius_policy, dist_lt, distance, gcl, has_predicate_value, has_type, hpad, id_escape, ids_to_show, is_a_main_node, is_node_to_always_show, is_one_of, linearize, node_radius_policies, start_with_http, unescape_unicode, uniquer, wpad,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.init_gclc = function() {
      ...
      if (!this.local_file_loader && this.args.local_file_loader__append_to_sel) {
        this.local_file_loader = new LocalFileLoader(this, this.args.local_file_loader__append_to_sel);
      }
      if (this.gclui == null) {
    ...
    Huviz.prototype.init_editc = function() {
      return this.editui = new EditController(this);
    };

    Huviz.prototype.indexed_dbservice = function() {
      return this.indexeddbservice = new IndexedDBService(this);
    };

    Huviz.prototype.init_indexddbstorage = function() {
      return this.dbsstorage = new IndexedDBStorageController(this);
    };
  ...
  LocalFileLoader = (function() {
    ...
    LocalFileLoader.prototype.supports_file_dnd = function() {
      var div;
    ...
    LocalFileLoader.prototype.find_or_append_form = function() {
      if (!$(this.local_file_form_sel).length) {
        $(this.append_to_sel).append(this.tmpl);
      }
      ...
      return this.form.on('drop', (function(_this) {
        return function(e) {
          var droppedFiles, firstFile, reader;
          ...
          if (droppedFiles.length) {
            ...
            _this.form.find('.box__success').text(firstFile.name);
            _this.form.find('.box__success').show();
            reader = new FileReader();
            reader.onload = function(evt) {
              console.log("evt", evt);
              return _this.huviz.read_data_and_show(firstFile.name, evt.target.result);
            };
            return reader.readAsText(firstFile);
          }
        };
      })(this));
    };
  ...
  IndexedDBService = (function() {
    function IndexedDBService(huviz) {
      ...
      if (!this.datasetDB && indexedDB) {
        this.dbNm = "dataDB2";
        this.dbVer = 1;
        this.dbStoreName = "spogis";
        req = indexedDB.open(this.dbNm, this.dbVer);
        console.log(req);
        req.onsuccess = (function(_this) {
          return function(evt) {
            ...
            return _this.dsetDB = req.result;
          };
        })(this);
        req.onerror = (function(_this) {
          return function(evt) {
            return console.error("IndexDB Error: " + evt.target.error.message);
          };
        })(this);
    ...
    IndexedDBService.prototype.add_node_to_db = function(quad) {
      ...
      console.log(quad);
      return console.log(this.dsetDB);
    };
  ...
  IndexedDBStorageController = (function() {
    function IndexedDBStorageController(huviz, graph_uri) {
      this.huviz = huviz;
    ...
    IndexedDBStorageController.prototype.assert = function(quad) {
      ...
      assrtSave = new indexdDBstore.IndexedDBService(this.huviz);
      return assrtSave.add_node_to_db(quad);
    };
