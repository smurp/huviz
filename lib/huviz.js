  ...
  Huviz = (function() {
    ...
    Huviz.prototype.init_resource_menus = function() {
      ...
      if (!this.script_loader && this.args.script_loader__append_to_sel) {
        this.script_loader = new PickOrProvideScript(this, this.args.script_loader__append_to_sel, 'Script', 'ScriptPP', false, false, {
    ...
    Huviz.prototype.make_tabs_html = function() {
      var firstClass, id, t, theDivs, theTabs, _i, _len, _ref;
      this.cssClassToTabId = {};
      theTabs = "<ul class=\"the-tabs\">";
      theDivs = "<div id=\"gclui\"></div>";
      _ref = this.tabs_specs;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        t = _ref[_i];
        id = unique_id();
        firstClass = t.cssClass.split(' ')[0];
        this.cssClassToTabId[firstClass] = id;
    ...
    Huviz.prototype.create_tabs_adjacent = function(elem, position) {
      return elem.insertAdjacentHTML(position, this.make_tabs_html());
    };

    Huviz.prototype.create_tabs = function() {
      var elem, position;
      elem = document.querySelector(this.args.create_tabs_adjacent_to_selector);
      position = this.args.create_tabs_adjacent_position || 'afterend';
      return this.create_tabs_adjacent(elem, position);
    };
    ...
    function Huviz(args) {
      ...
      this.args.create_tabs_adjacent_to_selector = "#expand_cntrl";
      this.args.create_tabs_adjacent_position = "afterend";
      if (this.args.create_tabs_adjacent_to_selector && false) {
        this.create_tabs();
      }
      this.init_ontology();
