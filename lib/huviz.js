...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.clear_all_sets = function() {
      var cleanup_verb, set_key, set_label, skip_sets, the_set, _ref;
      ...
      for (set_key in _ref) {
        ...
        this.huviz.run_command(new gcl.GraphCommand({
          verbs: [cleanup_verb],
          sets: [the_set]
        }));
      }
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.init_sets = function() {
      ...
      this.discarded_set.docs = "Nodes which have been discarded so they will not be included in graphs." + (this.discarded_set.cleanup_verb = "shelve");
      this.hidden_set = SortedSet().sort_on("id").named("hidden").isState();
