...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.build_nodeclasspicker = function() {
      ...
      this.taxon_picker.click_listener = this.on_taxon_picked;
      return this.taxon_picker.show_tree(this.hierarchy, this.nodeclassbox);
    };
    ...
    CommandController.prototype.on_taxon_picked = function(id, new_state, elem, propagate_DEPRECATED) {
...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.update_all_counts = function() {
      ...
      this.update_taxon_counts();
      return this.update_predicate_counts();
    };
    ...
    Huviz.prototype.update_taxon_counts = function() {
      var count, lid, taxon, _ref, _results;
      _ref = this.taxonomy;
      _results = [];
      for (lid in _ref) {
        taxon = _ref[lid];
        count = taxon.instances.length;
        _results.push(this.gclui.on_taxon_count_update(lid, count));
      }
      return _results;
    };

    Huviz.prototype.update_predicate_counts = function() {
      var msg, predicate, selcnt, shwcnt, _i, _len, _ref, _results;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        msg = "" + shwcnt + "/" + selcnt;
        _results.push(this.gclui.on_predicate_count_update(predicate.lid, msg));
      }
      return _results;
    };
  ...
  Predicate = (function(_super) {
    ...
    Predicate.prototype.recalc_direct_state = function() {
      if (this.selected_instances.length === 0) {
        return "empty";
      } else if (this.only_some_selected_instances_are_shown()) {
        return "mixed";
      } else if (this.selected_instances.length > 0 && this.all_selected_instances_are_shown()) {
        return "showing";
      } else if (this.no_selected_instances_are_shown()) {
        return "unshowing";
      } else {
    ...
    Predicate.prototype.no_selected_instances_are_shown = function() {
      var e, _i, _len, _ref;
    ...
    Predicate.prototype.all_selected_instances_are_shown = function() {
      var e, _i, _len, _ref;
      _ref = this.selected_instances;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        e = _ref[_i];
    ...
    Predicate.prototype.only_some_selected_instances_are_shown = function() {
  ...
  Taxon = (function(_super) {
    ...
    Taxon.prototype.recalc_direct_state = function() {
      if (this.selected_instances.length + this.unselected_instances.length === 0) {
        return "unshowing";
      }
      if (this.selected_instances.length > 0 && this.unselected_instances.length > 0) {
        return "mixed";
      }
      if (this.unselected_instances.length === 0) {
        return "showing";
      }
      if (this.selected_instances.length === 0) {
        return "unshowing";
      } else {
        throw "Taxon[" + this.id + "].recalc_state should not fall thru, #selected:" + this.selected_instances.length + " #unselected:" + this.unselected_instances.length;
      }
    };
  ...
  var TaxonBase, TreeCtrl, angliciser,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  TaxonBase = (function(_super) {
    __extends(TaxonBase, _super);

    function TaxonBase() {
      return TaxonBase.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  TreeCtrl = (function() {
    ...
    TreeCtrl.prototype.update_state = function(inst, change) {
      ...
      this.recalc_states();
      if (old_indirect_state !== this.indirect_state && old_indirect_state === 'abstract') {
        console.log(this.lid, "was abstract");
      }
      if (old_state !== this.state || old_indirect_state !== this.indirect_state) {
        ...
        if (this.super_class != null) {
          return this.super_class.update_state();
        }
      }
    };
...
(function() {
  ...
  TreePicker = (function() {
    ...
    TreePicker.prototype.DEPRECATED_set_state_by_id = function(id, state, old_state) {
      var indirect_state, new_indirect_state;
      alert("deprecated");
      this.set_direct_state(id, state, old_state);
      if (this.is_leaf(id)) {
    ...
    TreePicker.prototype.onChangeState = function(evt) {
      ...
      if (det.new_indirect_state != null) {
        return this.set_both_states_by_id(det.target_id, det.new_state, det.new_indirect_state, det.old_state, det.old_indirect_state);
      } else {
        return this.set_state_by_id(det.target_id, det.new_state, det.old_state);
      }
    };
