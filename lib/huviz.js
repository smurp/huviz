    ...
    Huviz.prototype.draw_labels = function() {
      ...
      if (this.use_canvas || this.use_webgl) {
        ...
        label_node = (function(_this) {
          return function(node) {
            var adjust_x, adjust_y, alpha, ctx, cuts, fill, flip, i, line_height, node_font_size, outline, pill_height, pill_width, print_label, radians, radius, result, text, textAlign, text_split, x, y, _i, _len;
