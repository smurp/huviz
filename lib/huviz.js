...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.get_script_body_as_json = function() {
      ...
      replacer = function(key, value) {
        var lid, node_or_lid, retlist, setId, set_or_id, _j, _k, _len1, _len2;
        retlist = [];
        if (key === 'subjects') {
          for (_j = 0, _len1 = value.length; _j < _len1; _j++) {
            node_or_lid = value[_j];
            lid = node_or_lid.lid || node_or_lid;
            retlist.push(lid);
          }
          return retlist;
        }
    ...
    CommandController.prototype.on_downloadscript_clicked = function(txtOrJson) {
      ...
      thisName = prompt("What would you like to call your saved script?", this.get_downloadscript_name(txtOrJson));
      if (!thisName) {
        return;
      }
  ...
  GraphCommand = (function() {
    ...
    GraphCommand.prototype.update_str = function() {
      var aSet, cmd_str, like_str, maybe_every, missing, more, obj_phrase, ready, regarding_phrase, regarding_required, setLabel, setLabels, subj, verb, _i, _j, _len, _len1, _ref, _ref1;
      ...
      if (this.sets != null) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          aSet = _ref[_i];
          setLabel = typeof aSet === 'string' || aSet.get_label();
