...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.make_command_history = function() {
      ...
      this.scriptDownloadButton = this.scriptPlayerControls.append('button').attr('title', 'save script').attr('style', 'margin-left:1em').on('click', this.on_downloadscript_clicked);
    ...
    CommandController.prototype.get_downloadscript_name = function() {
      return this.lastScriptName || 'HuVizScript.txt';
    };
    ...
    CommandController.prototype.on_downloadscript_clicked = function() {
      var filename, node, theBod, theHref, transientLink;
      ...
      this.lastScriptName = prompt("What would you like to call your saved script?", this.get_downloadscript_name());
