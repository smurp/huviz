...
(function(/*! Stitch !*/) {
...
}).call(this)({"coloredtreepicker": function(exports, require, module) {(function() {
  ...
  ColoredTreePicker = (function(superClass) {
    ...
    ColoredTreePicker.prototype.add = function(id, parent_id, name, listener) {
      ColoredTreePicker.__super__.add.call(this, id, parent_id, name, listener);
    };
    ...
    ColoredTreePicker.prototype.recolor_node = function(a_node, recursor, id, elem_raw, indent) {
      var elem, hue, ref;
    ...
    ColoredTreePicker.prototype.expand_by_id = function(id) {
      ...
      ColoredTreePicker.__super__.expand_by_id.call(this, id);
    };
...
(function() {
  var ColoredTreePicker, CommandController, QueryManager, TreePicker, getRandomId,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.on_set_picked = function(set_id, new_state) {
      ...
      if (new_state === 'showing') {
        ...
        this.taxon_picker.unshield();
        XXXcmd = new GraphCommand(this.huviz, {
          verbs: ['unselect'],
          sets: [this.chosen_set.id]
        });
        this.disengage_all_sets();
  ...
  var BASE10, BASE57, CommandController, DCE_title, DC_subject, DragAndDropLoader, DragAndDropLoaderOfScripts, EditController, FOAF_Group, FOAF_Person, FOAF_name, GeoUserNameWidget, GreenerTurtle, Huviz, IndexedDBService, IndexedDBStorageController, MANY_SPACES_REGEX, NAME_SYNS, OA_, OA_terms_regex, OSMT_name, OSMT_reg_name, OWL_Class, OWL_ObjectProperty, OWL_Thing, OntoViz, OntologicallyGrounded, Orlando, PEEKING_COLOR, PRIMORDIAL_ONTOLOGY, PickOrProvide, PickOrProvideScript, RDFS_label, RDF_Class, RDF_a, RDF_literal, RDF_object, RDF_subClassOf, RDF_type, SCHEMA_name, SKOS_prefLabel, SettingsWidget, Socrata, THUMB_PREDS, TYPE_SYNS, UNDEFINED, UsernameWidget, XL_literalForm, XML_TAG_REGEX, colorlog, convert, default_node_radius_policy, dist_lt, distance, escapeHtml, getPrefixedTypeSignature, getTypeSignature, has_predicate_value, has_type, hash, hpad, id_escape, ident, ids_to_show, int_to_base, is_a_main_node, is_node_to_always_show, is_one_of, linearize, node_radius_policies, noop, orlando_human_term, sel_to_id, start_with_http, strip_surrounding_quotes, synthIdFor, tau, themeStyles, typeSigRE, unescape_unicode, unique_id, unpad_md, wpad,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.find_node_or_edge_closest_to_pointer_using_d3 = function() {
      var closest_node, ref, x, y;
      if (this.should_display_labels_as('boxNGs')) {
        return;
      }
      ref = this.last_mouse_pos, x = ref[0], y = ref[1];
    ...
    Huviz.prototype.update_canvas_pill = function(node, ctx) {
      var adjust_x, adjust_y, alpha, cuts, fill, i, j, len1, line_height, node_font_size, outline, pill_height, pill_width, print_label, radius, result, text, text_split, x, y;
    ...
    Huviz.prototype.is_in_viewport = function(node) {
      var ref, ref1;
      return ((0 < (ref = node.fisheye.x) && ref < this.width)) && ((0 < (ref1 = node.fisheye.y) && ref1 < this.height));
    };
    ...
    Huviz.prototype.update_state = function(node) {
      ...
      if ((ref = node.state) === this.discarded_set || ref === this.hidden_set || ref === this.shelved_set) {
        this.remove_boxNG(node);
        if (node.focused_node) {
          this.set_focused_node();
        }
    ...
    Huviz.prototype.make_tabs_html = function() {
      var firstClass, firstClass_, html, id, idSel, idx, j, jQElem_list, len1, mkcb, t, tab_id, tab_specs, theDivs, theTabs;
      jQElem_list = [];
    ...
    function Huviz(incoming_args) {
      ...
      this.mouseup_boxNG = bind(this.mouseup_boxNG, this);
      this.mouseenter_boxNG = bind(this.mouseenter_boxNG, this);
      this.mouseout_boxNG = bind(this.mouseout_boxNG, this);
      this.mousedown_boxNG = bind(this.mousedown_boxNG, this);
      this.mousemove_boxNG = bind(this.mousemove_boxNG, this);
    ...
    Huviz.prototype.pfm_update = function() {
      var calls_per_second, class_count, item, k, marker, marker_elem, new_count, noE, noN, noOR, noP, old_count, pfm_marker, pfm_marker_sel, ref, results1, time, v, val;
      time = Date.now();
      class_count = 0;
      if (this.nodes) {
      ...
      for (pfm_marker in this.pfm_data) {
        ...
        if (marker.timed_count && (marker.timed_count.length > 0)) {
          ...
          if ((marker_elem = document.querySelector(pfm_marker_sel))) {
            results1.push(sparkline.sparkline(marker_elem, marker.timed_count));
          } else {
            throw new Error("#pfm_" + pfm_marker + " matches no elements");
          }
        } else if (marker.timed_count) {
          results1.push(marker.timed_count = [0.01]);
        } else {
          results1.push(void 0);
        }
      }
...
(function() {
  ...
  TreePicker = (function() {
    ...
    TreePicker.prototype.show_tree = function(tree, i_am_in, listener, top) {
      var contents_of_me, css_class, i, label, len, my_contents, node_id, picker, ref, rest;
      top = (top == null) || top;
      for (node_id in tree) {
        rest = tree[node_id];
        label = rest[0];
    ...
    TreePicker.prototype.effect_click = function(id, new_state, send_leafward, listener, args) {
      ...
      if (listener != null) {
        elem = this.id_to_elem[id];
        listener.call(this, id, new_state, elem, args);
      }
    };
