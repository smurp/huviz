...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.push_sparqlQuery_onto_log = function(qry, meta) {
      var id, preElem, preJQElem, qryJQElem, qryLogObj, queriesJQElem;
      if (meta == null) {
        meta = {};
      }
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.log_query_with_timeout = function(qry, timeout, fillColor, bgColor) {
      var qryLogObj;
      qryLogObj = this.log_query(qry);
      this.animate_sparql_query(qryLogObj.preElem, timeout, fillColor, bgColor);
      return qryLogObj;
    };
    ...
    Huviz.prototype.sparql_graph_query_and_show = function(url, id, callback) {
      var ajax_settings, graphSelector, qry, qryLogObj, spinner, timeout;
      qry = "SELECT ?g\nWHERE {\n  GRAPH ?g { }\n}";
      ajax_settings = {
        'type': 'GET',
      ...
      timeout = this.get_sparql_timeout_msec();
      qryLogObj = this.log_query_with_timeout(qry, timeout);
    ...
    Huviz.prototype.load_endpoint_data_and_show = function(subject, callback) {
      var ajax_settings, fromGraph, node_limit, qry, timeout, url;
      ...
      timeout = this.get_sparql_timeout_msec();
      this.log_query_with_timeout(qry, timeout);
      ajax_settings = {
        'method': 'GET',
        'url': url + '?query=' + encodeURIComponent(qry),
        'headers': {
    ...
    Huviz.prototype.load_new_endpoint_data_and_show = function(subject, callback) {
      var ajax_settings, fromGraph, node_limit, note, qry, qryLogObj, timeout, url;
      node_limit = this.endpoint_limit_JQElem.val();
    ...
    Huviz.prototype.add_nodes_from_SPARQL_Worker = function(queryTarget) {
      var graph, local_node_added, previous_nodes, query_limit, timeout, url, worker;
      ...
      worker.addEventListener('message', (function(_this) {
        return function(e) {
          var a_node, add_fully_loaded, i, qryLogObj, quad, _i, _j, _len, _len1, _ref, _ref1;
          if (e.data.method_name === 'log_query') {
            qryLogObj = _this.log_query_with_timeout("#SPARQL_Worker\n" + e.data.qry, timeout);
            return;
    ...
    Huviz.prototype.kill_endpoint_label_search_anim = function() {
      this.endpoint_label_search_anim.cancel = true;
      window.cancelAnimationFrame(this.endpoint_label_search_anim.animId);
    ...
    Huviz.prototype.populate_graphs_selector = function(request, response) {
      var ajax_settings, fromGraph, more, qry, qryLogObj, spinner, timeout, url;
