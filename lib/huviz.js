...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.walk__atLast = function() {
      var connected_path, current_selection, e, found_it, hot_nodes, lid, node, node_lid, nowRollCall, old_node, removed, valid_path_nodes, wasRollCall, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _m, _n, _o, _p, _q, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      wasRollCall = this.wasChosen_set.roll_call();
      nowRollCall = this.nowChosen_set.roll_call();
      ...
      console.log(this.wasChosen_set);
      console.log("nowChosen_set:");
      console.log(this.nowChosen_set);
      ...
      for (_o = 0, _len6 = valid_path_nodes.length; _o < _len6; _o++) {
        ...
        if (current_selection === node_lid) {
          connected_path = true;
        }
      }
      if (connected_path) {
        this.walk_path_set.push(current_selection);
        ...
        for (_p = 0, _len7 = hot_nodes.length; _p < _len7; _p++) {
          node = hot_nodes[_p];
          console.log(node);
          removed.push(node);
        }
