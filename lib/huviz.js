...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.maximize_gclui = function() {
      ...
      return this.tabsJQElem.find('.maximize_cntrl').prop('style', 'visibility:hidden');
    };

    Huviz.prototype.create_collapse_expand_handles = function() {
      var html;
      html = "<div class=\"expand_cntrl\" style=\"visibility:hidden\"><i class=\"fa fa-angle-double-left\"></i></div>\n<div class=\"collapse_cntrl\"><i class=\"fa fa-angle-double-right\"></i></div>";
      this.tabsJQElem.prepend(html);
      this.expandCtrlJQElem = this.tabsJQElem.find(".expand_cntrl");
      this.expandCtrlJQElem.click(this.maximize_gclui).on("click", this.updateWindow);
      this.collapseCtrlJQElem = this.tabsJQElem.find(".collapse_cntrl");
      this.collapseCtrlJQElem.click(this.minimize_gclui).on("click", this.updateWindow);
    };
