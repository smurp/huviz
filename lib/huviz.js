  ...
  EditController = (function() {
    ...
    EditController.prototype.set_proposed_edge = function(new_q) {
      ...
      if (this.proposed_edge != null) {
        return this.remove_and_add_proposed_edge(this.proposed_edge, new_q);
      } else {
    ...
    EditController.prototype.add_proposed_quad = function(q) {
      var new_propsed_edge, obj_n, pred_n, subj_n;
      ...
      new_propsed_edge = this.huviz.get_or_create_Edge(subj_n, obj_n, pred_n);
      this.huviz.show_link(new_propsed_edge);
      this.proposed_edge = q;
      return this.deleted_last_edge = true;
    };

    EditController.prototype.remove_and_add_proposed_edge = function(old_q, new_q) {
      ...
      this.deleted_last_edge = true;
      delete this.huviz.edges_by_id[old_e];
      return this.add_proposed_quad(new_q);
    };
