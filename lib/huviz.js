  ...
  */
  ...
  Deprecated = (function(_super) {
    ...
    Deprecated.prototype.hide_all_links = function() {
      ...
      this.links_set.forEach(function(link) {
    ...
    Deprecated.prototype.find_links_from_node = function(node) {
      ...
      if (subj) {
        for (p_name in subj.predicates) {
          ...
          oi = 0;
          predicate.objects.forEach(function(obj, i) {
    ...
    Deprecated.prototype.find_links_to_node = function(d) {
      ...
      if (subj) {
        ...
        this.G.get_incoming_predicates(subj).forEach(function(sid_pred) {
          var pred, sid, src;
          sid = sid_pred[0];
          pred = sid_pred[1];
  ...
  FiniteStateMachine = (function() {
    ...
    FiniteStateMachine.prototype.transit = function(trans_id) {
      var called, initial_state, msg, target_id, transition, _ref;
      if ((_ref = this.transitions) == null) {
        this.transitions = {};
      }
...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.push_sparqlQuery_onto_log = function(qry, meta) {
      var id, preElem, preJQElem, qryJQElem, queriesJQElem, queryManager, _ref;
      if (meta == null) {
        meta = {};
      }
      if ((_ref = meta.timestamp) == null) {
    ...
    CommandController.prototype.show_succession_of_hints = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        $(reminder).append('<i class="fa fa-close close_hint"></i>').on("click", function(evt, ui) {
    ...
    CommandController.prototype.make_predicate_proposable = function(pred_lid) {
      ...
      predicate_ctl.on('mouseenter', function() {
      ...
      return predicate_ctl.on('mouseleave', function() {
    ...
    CommandController.prototype.make_taxon_proposable = function(taxon_id) {
      ...
      taxon_ctl.on('mouseenter', function(evt) {
        var ready;
      ...
      taxon_ctl.on('mouseleave', function(evt) {
        var ready;
    ...
    CommandController.prototype.build_submit = function() {
      ...
      this.doit_butt.on('click', function() {
    ...
    */
    ...
    CommandController.prototype.make_sets_proposable = function() {
      var a_set, id, make_listeners, _ref, _results,
        _this = this;
      make_listeners = function(id, a_set) {
        var set_ctl;
  ...
  GCLTest = (function() {
    ...
    GCLTest.prototype.perform = function() {
      var exp, expected, got, msg, _i, _len, _ref, _ref1;
      if (this.spec.script) {
  ...
  GCLTestSuite = (function() {
    ...
    */
    ...
    GCLTestSuite.prototype.run = function() {
      var err, errors, fail, fails, num, pass_count, passed, retval, spec, test, _i, _j, _k, _len, _len1, _len2, _ref, _results;
      pass_count = 0;
      errors = [];
      fails = [];
      num = 0;
  ...
  GraphCommand = (function() {
    ...
    function GraphCommand(huviz, args_or_str) {
      ...
      if ((_ref = args.skip_history) == null) {
        args.skip_history = false;
      }
      if ((_ref1 = args.every_class) == null) {
    ...
    GraphCommand.prototype.update_str = function() {
      var aSet, cmd_str, like_str, maybe_every, missing, more, obj_phrase, ready, regarding_phrase, regarding_required, set, setLabel, setLabels, subj, verb, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      ...
      if ((_ref = this.object_phrase) == null) {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.how_heavy_are = function(n, label, cb) {
      var after, before, buncha, diff, k, m, memories, per, retval, _i, _ref;
      memories = [];
      memories.push(window.performance.memory);
      if ((_ref = this.heavy_things) == null) {
        this.heavy_things = {};
      }
      buncha = [];
    ...
    Huviz.prototype.mousemove = function() {
      var action, cursor_text, edge, edit_state, pair, _i, _len, _ref, _ref1, _ref2;
    ...
    Huviz.prototype.find_node_or_edge_closest_to_pointer = function() {
      ...
      this.all_set.forEach(function(d, i) {
        var n_dist;
      ...
      this.links_set.forEach(function(e, i) {
    ...
    Huviz.prototype.highwater_incr = function(id) {
      var hwm, _ref;
      if ((_ref = this.highwatermarks) == null) {
        this.highwatermarks = {};
      }
    ...
    Huviz.prototype.install_update_pointer_togglers = function() {
      ...
      d3.select("#huvis_controls").on("mouseover", function() {
        _this.update_pointer = false;
        return _this.text_cursor.pause("default");
      });
      return d3.select("#huvis_controls").on("mouseout", function() {
    ...
    Huviz.prototype.get_focused_node_and_its_state = function() {
      ...
      if (!(focused.state != null)) {
        ...
        if ((_ref = focused._warnings) == null) {
          focused._warnings = {};
        }
    ...
    Huviz.prototype.position_nodes_by_force = function() {
      ...
      return this.nodes.forEach(function(node, i) {
    ...
    Huviz.prototype.apply_fisheye = function() {
      var _this = this;
      this.links_set.forEach(function(e) {
        if (!e.target.fisheye) {
    ...
    Huviz.prototype.draw_edges = function() {
      ...
      if (this.use_canvas) {
        this.graphed_set.forEach(function(node, i) {
      ...
      if (this.use_webgl && false) {
        return this.links_set.forEach(function(e, i) {
          var v;
          if (!e.gl) {
            return;
          }
    ...
    Huviz.prototype.draw_nodes = function() {
      ...
      if (this.use_canvas || this.use_webgl) {
        return this.graphed_set.forEach(function(d, i) {
          var filclr, imageData, imgUrl, node_radius, pill_height, pill_width, rndng, special_focus, stroke_color, x, y;
    ...
    Huviz.prototype.get_or_create_round_img = function(url) {
      var ctx, display_image_size, img, imgId, origImage, roundImage, round_image_maker, _ref;
      if ((_ref = this.round_img_cache) == null) {
    ...
    Huviz.prototype.draw_labels = function() {
      ...
      if (this.use_canvas || this.use_webgl) {
        ...
        label_node = function(node) {
          var adjust_x, adjust_y, alpha, ctx, cuts, fill, flip, flip_point, i, label, line_height, node_font_size, outline, pill_height, pill_width, print_label, radians, radius, result, text, textAlign, text_split, x, y, _i, _len;
      ...
      if (true) {
        if (this.clean_up_all_dirt_onceRunner != null) {
          if (this.clean_up_all_dirt_onceRunner.active) {
            if ((_ref = (_base = this.clean_up_all_dirt_onceRunner.stats).runTick) == null) {
              _base.runTick = 0;
            }
            if ((_ref1 = (_base1 = this.clean_up_all_dirt_onceRunner.stats).skipTick) == null) {
              _base1.skipTick = 0;
            }
    ...
    Huviz.prototype.getTesterAndMunger = function(discoArgs) {
      var fallbackQuadMunter, fallbackQuadTester, quadMunger, quadTester,
        _this = this;
      fallbackQuadTester = function(q) {
        return q != null;
      };
      fallbackQuadMunter = function(q) {
        return [q];
      };
    ...
    Huviz.prototype.discovery_triple_ingestor_N3 = function(data, textStatus, request, discoArgs) {
      ...
      quad_count = 0;
      parser = N3.Parser();
      return parser.parse(data, function(err, quad, pref) {
    ...
    Huviz.prototype.discover_geoname_name = function(aUrl) {
      var id, idInt, k2p, rem, soughtId, url, userId, widget, _ref,
        _this = this;
      ...
      if ((_ref = this.geonames_name_lookups_performed) == null) {
      ...
      $.ajax({
        ...
        success: function(json, textStatus, request) {
          var again, containershipQuad, deeperQuad, deeply, depth, geoNamesRoot, geoRec, greedily, key, msg, name, placeQuad, pred, quad, seen_name, soughtGeoname, state_at_start, subj, theType, value, _i, _len, _ref1, _ref2, _step;
          if (json.status) {
            if ((_ref1 = _this.discover_geoname_name_msgs) == null) {
            ...
            if (state_at_start === 'trying' || state_at_start === 'looking') {
              ...
              if (widget.state === 'looking') {
                if (_this.discover_geonames_remaining > 0) {
                  again = function() {
                    return _this.discover_names('geonames.org');
                  };
          ...
          depth = 0;
          _ref2 = json.geonames;
          for (_i = 0, _len = _ref2.length, _step = -1; _i < _len; _i += _step) {
            geoRec = _ref2[_i];
            if (!depth) {
    ...
    */
    ...
    Huviz.prototype.auto_discover_name_for = function(namelessUri) {
      var aUrl, args, downloadUrl, hasDomainName, retval, serverSpec, serverUrl, try_even_though_CORS_should_block, _ref;
    ...
    Huviz.prototype.discover_names = function(includes) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (!((includes != null) && !uri.includes(includes))) {
          this.auto_discover_name_for(uri);
        }
      }
    };

    Huviz.prototype.run_sparql_name_query = function(args) {
      var defaults, namelessUri, _ref;
    ...
    Huviz.prototype.tsv_name_success_handler = function(data, textStatus, jqXHR, queryManager) {
      var cols, firstLine, line, lines, result_handler, row, rowJson, table, _i, _len;
    ...
    Huviz.prototype.json_name_success_handler = function(data, textStatus, jqXHR, queryManager) {
      var resultJson, result_handler, table, _i, _len, _ref;
      result_handler = queryManager.args.result_handler;
      try {
        table = [];
    ...
    Huviz.prototype.generic_name_success_handler = function(data, textStatus, jqXHR, queryManager) {
      var resp_content_type, resp_type, serverDesc, success_handler;
      try {
    ...
    Huviz.prototype.convert_N3_obj_to_GreenTurtle = function(n3_obj_term) {
      var bare_obj_term, graph, pred, retval, statement, subj, _ref;
      ...
      if ((_ref = this.greenturtleparser) == null) {
    ...
    Huviz.prototype.name_result_handler = function(result, queryManager) {
      var obj_term, parseObj, parseUri, pred_term, q, result_type, subj_term, terms;
    ...
    Huviz.prototype.remove_from_nameless = function(node) {
      var node_removed, _ref;
      if (node.nameless != null) {
        if ((_ref = this.nameless_removals) == null) {
    ...
    Huviz.prototype.add_to_nameless = function(node) {
      ...
      if ((_ref = (_base = this.nameless_set).traffic) == null) {
        _base.traffic = 0;
      }
    ...
    Huviz.prototype.infer_edge_end_types = function(edge) {
      var domain_lid, ranges, _base, _base1, _ref, _ref1;
      if ((_ref = (_base = edge.source).type) == null) {
        _base.type = 'Thing';
      }
      if ((_ref1 = (_base1 = edge.target).type) == null) {
        _base1.type = 'Thing';
      }
    ...
    Huviz.prototype.parseAndShowTTLData = function(data, textStatus, callback) {
      var blurt_msg, context, every, frame, msg, obj, parse_start_time, pred, pred_id, quad_count, subj_uri, _i, _len, _ref, _ref1, _ref2;
    ...
    Huviz.prototype.parseAndShowTurtle = function(data, textStatus) {
      ...
      if ((GreenerTurtle != null) && this.turtle_parser === 'GreenerTurtle') {
        ...
        predicates = {};
        parser = N3.Parser();
        parser.parse(data, function(err, trip, pref) {
          console.log(trip);
          if (pref) {
            console.log(pref);
          }
    ...
    Huviz.prototype.fetchAndShow = function(url, callback) {
      ...
      if (url.startsWith('file:///') || url.indexOf('/') === -1) {
        this.get_resource_from_db(url, function(err, rsrcRec) {
          if (rsrcRec != null) {
    ...
    Huviz.prototype.run_managed_query_abstract = function(args) {
      var queryManager, _ref, _ref1, _ref2;
      if (args == null) {
        args = {};
      }
      if ((_ref = args.success_handler) == null) {
        args.success_handler = noop;
      }
      if ((_ref1 = args.error_callback) == null) {
        args.error_callback = noop;
      }
      if ((_ref2 = args.timeout) == null) {
    ...
    Huviz.prototype.sparql_graph_query_and_show = function(url, id, callback) {
      ...
      handle_graphsNotFound = function() {
        $(graphSelector).parent().css('display', 'none');
        _this.reset_endpoint_form(true);
        return _this.enable_go_button();
      };
      make_success_handler = function() {
    ...
    Huviz.prototype.clean_up_all_dirt_once = function() {
      var _ref;
      if ((_ref = this.clean_up_all_dirt_onceRunner) == null) {
    ...
    Huviz.prototype.prove_OnceRunner = function(timeout) {
      var yahoo, _ref;
      if ((_ref = this.prove_OnceRunner_inst) == null) {
    ...
    Huviz.prototype.get_or_create_node_by_id = function(uri, name, isLiteral) {
      ...
      if ((_ref = node.type) == null) {
        node.type = "Thing";
      }
      if ((_ref1 = node.lid) == null) {
    ...
    Huviz.prototype.make_links = function(g, limit) {
      var _this = this;
      limit = limit || 0;
      this.nodes.some(function(node, i) {
        var subj;
        subj = node.s;
    ...
    Huviz.prototype.choose = function(chosen, callback_after_choosing) {
      ...
      if (this.using_sparql() && !chosen.fully_loaded && !this.outstanding_sparql_requests_are_capped()) {
        callback_after_getting_neighbors = function() {
    ...
    Huviz.prototype.wander__atLast = function() {
      ...
      removed = this.wasChosen_set.filter(function(node) {
    ...
    Huviz.prototype.walkBackTo = function(existingStep) {
      var pathNode, removed, _i, _len, _ref, _step;
      removed = [];
    ...
    Huviz.prototype.recolor_node = function(n, default_color) {
      var color, taxon_id, _i, _len, _ref, _ref1, _results;
      if (default_color == null) {
        default_color = 'black';
      }
      if ((_ref = n._types) == null) {
        n._types = [];
      }
    ...
    Huviz.prototype.redact = function(node) {
      var _this = this;
      return node.links_shown.forEach(function(edge, i) {
    ...
    Huviz.prototype.draw_edge_regarding = function(node, predicate_lid) {
      ...
      node.links_from.forEach(function(edge, i) {
        return doit(edge, i, 'from');
      });
      node.links_to.forEach(function(edge, i) {
    ...
    Huviz.prototype.update_history = function() {
      ...
      if (window.history.pushState) {
        ...
        if (chosen_set.length) {
          ...
          this.chosen_set.forEach(function(chosen, i) {
            hash += chosen.id;
    ...
    Huviz.prototype.ensure_datasets = function(preload_group, store_in_db) {
      var defaults, ds_rec, k, _i, _len, _ref, _ref1, _results;
    ...
    Huviz.prototype.ensure_dataset = function(rsrcRec, store_in_db) {
      var uri, _ref, _ref1, _ref2, _ref3, _ref4;
      uri = rsrcRec.uri;
      if ((_ref = rsrcRec.time) == null) {
        rsrcRec.time = new Date().toString();
      }
      if ((_ref1 = rsrcRec.title) == null) {
        rsrcRec.title = uri;
      }
      if ((_ref2 = rsrcRec.isUri) == null) {
        rsrcRec.isUri = !!uri.match(/^(http|ftp)/);
      }
      if ((_ref3 = rsrcRec.canDelete) == null) {
        rsrcRec.canDelete = !!(rsrcRec.time != null);
      }
      if ((_ref4 = rsrcRec.label) == null) {
    ...
    Huviz.prototype.populate_menus_from_IndexedDB = function(why) {
      ...
      count = 0;
      make_onsuccess_handler = function(why) {
        var recs;
        recs = [];
    ...
    Huviz.prototype.get_or_create_sel_for_picker = function(specificSel) {
      var huvis_controls_sel, pickersId, sel, _ref;
      sel = specificSel;
      if (!(sel != null)) {
        if (!(this.pickersSel != null)) {
          ...
          if ((huvis_controls_sel = this.oldToUniqueTabSel['huvis_controls'])) {
            if ((_ref = this.huvis_controls_elem) == null) {
    ...
    Huviz.prototype.init_gclc = function() {
      ...
      if (!this.show_class_instance_edges) {
        TYPE_SYNS.forEach(function(pred_id, i) {
          return _this.gclui.ignore_predicate(pred_id);
        });
      }
      NAME_SYNS.forEach(function(pred_id, i) {
        return _this.gclui.ignore_predicate(pred_id);
      });
    ...
    Huviz.prototype.get_data_ontology_display_id = function() {
      var _ref;
      if ((_ref = this.data_ontology_display_id) == null) {
    ...
    Huviz.prototype.render_visualization_source_display = function(vis_src_args) {
      var add_reload_button, controls, dataset, endpoint, ontology, reload_html, script, sel, source_html, uri, visualization_source_display;
    ...
    Huviz.prototype.indexed_dbservice = function() {
      var _ref;
      return (_ref = this.indexeddbservice) != null ? _ref : this.indexeddbservice = new IndexedDBService(this);
    };

    Huviz.prototype.init_indexddbstorage = function() {
      var _ref;
      return (_ref = this.dbsstorage) != null ? _ref : this.dbsstorage = new IndexedDBStorageController(this, this.indexeddbservice);
    };
    ...
    Huviz.prototype.calculate_args = function(incoming_args) {
      ...
      if ((_ref = args.create_tabs_adjacent_to_selector) == null) {
    ...
    function Huviz(incoming_args) {
      ...
      if ((_ref = (_base = this.args).settings_sel) == null) {
    ...
    Huviz.prototype.get_or_create_settings_group = function(groupName) {
      var group, groupId, _ref;
      groupId = synthIdFor(groupName);
      if ((_ref = this.settings_groups) == null) {
    ...
    Huviz.prototype.init_settings_to_defaults = function() {
      var WidgetClass, control, controlElem, control_name, control_spec, event_type, groupElem, groupName, inputElem, inputId, k, labelElem, old_val, opt, optIdx, optionElem, settings_input_sel, v, value, _i, _len, _ref, _ref1, _ref2, _ref3;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (control_name in control_spec) {
          ...
          if (control.input != null) {
            ...
            event_type = control.event_type || (((_ref3 = control.input.type) === 'checkbox' || _ref3 === 'range' || _ref3 === 'radio') && 'input') || 'change';
    ...
    Huviz.prototype.pfm_update = function() {
      var calls_per_second, class_count, item, k, marker, new_count, noE, noN, noOR, noP, old_count, pfm_marker, time, v, val, _ref, _results;
      time = Date.now();
      class_count = 0;
      if (this.nodes) {
  ...
  PickOrProvide = (function() {
    ...
    PickOrProvide.prototype.add_uri = function(uri_or_rec) {
      var rsrcRec, uri, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      if ((_ref = rsrcRec.uri) == null) {
        rsrcRec.uri = uri;
      }
      if ((_ref1 = rsrcRec.isOntology) == null) {
        rsrcRec.isOntology = this.isOntology;
      }
      if ((_ref2 = rsrcRec.isEndpoint) == null) {
        rsrcRec.isEndpoint = this.isEndpoint;
      }
      if ((_ref3 = rsrcRec.time) == null) {
        rsrcRec.time = (new Date()).toISOString();
      }
      if ((_ref4 = rsrcRec.isUri) == null) {
        rsrcRec.isUri = true;
      }
      if ((_ref5 = rsrcRec.title) == null) {
        rsrcRec.title = rsrcRec.uri;
      }
      if ((_ref6 = rsrcRec.canDelete) == null) {
        rsrcRec.canDelete = !!(rsrcRec.time != null);
      }
      if ((_ref7 = rsrcRec.label) == null) {
        rsrcRec.label = rsrcRec.uri.split('/').reverse()[0] || rsrcRec.uri;
      }
      if (rsrcRec.label === "sparql") {
        rsrcRec.label = rsrcRec.uri;
      }
      if ((_ref8 = rsrcRec.rsrcType) == null) {
    ...
    PickOrProvide.prototype.add_local_file = function(file_rec) {
      ...
      if (typeof file_rec === 'string') {
        ...
        if ((_ref2 = rsrcRec.time) == null) {
          rsrcRec.time = (new Date()).toISOString();
        }
        if ((_ref3 = rsrcRec.isUri) == null) {
          rsrcRec.isUri = false;
        }
        if ((_ref4 = rsrcRec.title) == null) {
          rsrcRec.title = rsrcRec.uri;
        }
        if ((_ref5 = rsrcRec.canDelete) == null) {
          rsrcRec.canDelete = !!(rsrcRec.time != null);
        }
        if ((_ref6 = rsrcRec.label) == null) {
          rsrcRec.label = rsrcRec.uri.split('/').reverse()[0];
        }
        if ((_ref7 = rsrcRec.rsrcType) == null) {
          rsrcRec.rsrcType = this.opts.rsrcType;
        }
        if ((_ref8 = rsrcRec.data) == null) {
  ...
  DragAndDropLoader = (function() {
    ...
    DragAndDropLoader.prototype.find_or_append_form = function() {
      ...
      this.form.on('submit unfocus', function(evt) {
        var uri, uri_field;
      ...
      this.form.on('drag dragstart dragend dragover dragenter dragleave drop', function(evt) {
        evt.preventDefault();
        return evt.stopPropagation();
      });
      this.form.on('dragover dragenter', function() {
        _this.form.addClass('is-dragover');
        return console.log("addClass('is-dragover')");
      });
      this.form.on('dragleave dragend drop', function() {
        return _this.form.removeClass('is-dragover');
      });
      return this.form.on('drop', function(e) {
  ...
  IndexedDBService = (function() {
    ...
    IndexedDBService.prototype.expunge_db = function(dbname, callback) {
      ...
      return del_req.onsuccess = function(e) {
    ...
    IndexedDBService.prototype.initialize_db = function(callback) {
      ...
      when_done = function(db, why, cb, err) {
        _this.nstoreDB = db;
        if (cb != null) {
          return cb(err);
        }
