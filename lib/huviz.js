    ...
    CommandController.prototype.make_taxon_proposable = function(taxon_id) {
      ...
      taxon_ctl.on('mouseenter', (function(_this) {
        return function(evt) {
          ...
          console.log(_this.proposed_verb, _this.proposed_taxon);
          cmd = new gcl.GraphCommand(_this.huviz, {
            verbs: [_this.proposed_verb],
            classes: [_this.proposed_taxon]
          });
          return ready = _this.prepare_command(_this.build_command());
        };
      })(this));
      taxon_ctl.on('mouseleave', (function(_this) {
        return function(evt) {
          ...
          return _this.prepare_command(new gcl.GraphCommand(_this.huviz, {}));
        };
      })(this));
    };
