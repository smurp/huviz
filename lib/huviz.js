...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.run_sparql_name_query = function(args) {
      ...
      return this.run_managed_query_ajax(args.query, args.serverUrl, args);
    };
    ...
    Huviz.prototype.run_ldf_name_query = function(args) {
      ...
      args = this.compose_object_from_defaults_and_incoming(defaults, args);
      return this.run_managed_query_ldf(args.query, args.serverUrl, args);
    };

    Huviz.prototype.run_managed_query_ldf = function(qry, url, args) {
      var error_callback, ldf_worker, queryManager, result_handler, serverUrl, success_handler, timeout;
      if (args == null) {
        args = {};
      }
      if (args.worker == null) {
      ...
      success_handler = args.success_handler, error_callback = args.error_callback, timeout = args.timeout, result_handler = args.result_handler, serverUrl = args.serverUrl;
      if (serverUrl == null) {
