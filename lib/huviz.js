...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.on_taxon_clicked = function(id, new_state, elem) {
      ...
      if (new_state === 'showing') {
        ...
        if ((__indexOf.call(this.engaged_verbs, 'select') >= 0)) {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.snippet_triple_em = .7;
    ...
    Huviz.prototype.mouseright = function() {
      var all_names, color, color_headers, name, names_all_langs, node_info, node_type, note, other_types, width, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
      ...
      if (this.focused_node._colors) {
        ...
        _ref1 = this.focused_node._colors;
    ...
    Huviz.prototype.get_or_create_taxon = function(taxon_id) {
      ...
      if (this.taxonomy[taxon_id] == null) {
        ...
        this.gclui.add_new_taxon(taxon_id, parent_lid, label, taxon);
      }
    ...
    Huviz.prototype.add_quad = function(quad, sprql_subj) {
      var add_name, cntx_n, ctxid, edge, is_type, literal_node, make_edge, newsubj, objId, objKey, objVal, obj_n, pred_n, pred_uri, simpleType, subj, subj_lid, subj_n, subj_uri;
      subj_uri = quad.s;
      pred_uri = quad.p;
      ...
      if (quad.o.type === RDF_object) {
        ...
        if (is_one_of(pred_uri, NAME_SYNS)) {
          add_name = (function(_this) {
            return function() {
              return _this.set_name(subj_n, quad.o.value.replace(/^\s+|\s+$/g, ''), quad.o.language);
            };
          })(this);
          ...
          if (this.make_nodes_for_literals) {
            ...
            literal_node = this.get_or_create_node_by_id(objId);
    ...
    Huviz.prototype.get_or_create_node_by_id = function(uri, name) {
      var node, node_id;
      node_id = uri;
      ...
      if (node.name == null) {
        name = name || this.ontology.label[node.lid] || node.lid;
    ...
    Huviz.prototype.choose = function(chosen) {
      ...
      if (this.endpoint_loader.value) {
        if (!chosen.fully_loaded) {
          if (this.endpoint_loader.outstanding_requests < 300) {
            this.endpoint_loader.outstanding_requests = this.endpoint_loader.outstanding_requests + 1;
            this.load_new_endpoint_data_and_show(chosen.id);
  ...
  Orlando = (function(_super) {
    ...
    Orlando.prototype.push_snippet = function(msg_or_obj) {
      var dataType, dataType_curie, dataType_uri, m, obj, obj_dd, _ref;
      obj = msg_or_obj;
      if (this.snippet_box) {
        if (typeof msg_or_obj !== 'string') {
          _ref = ["", msg_or_obj], msg_or_obj = _ref[0], m = _ref[1];
          if (obj.quad.obj_uri) {
            obj_dd = "<dd>" + (this.make_link(obj.quad.obj_uri)) + "</dd>";
          } else {
