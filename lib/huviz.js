...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.build_like = function() {
      ...
      this.clear_like_button.attr('title', 'clear the "like" field');
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.draw_bubble = function(cx, cy, width, height, rndng, strclr, filclrs) {
      return this.rounded_rectangle(cx, cy, width, height, rndng, filclrs, strclr);
    };
    ...
    Huviz.prototype.set_focused_node = function(node) {
      ...
      if (this.focused_node) {
        console.log("focused_node:", this.focused_node);
          ...
          return function(d, i) {
            ...
            if (_this.use_canvas) {
              ...
              if (node_display_type === 'pills') {
                ...
                x = d.fisheye.x;
                y = d.fisheye.y;
                _this.draw_bubble(x, y, pill_width, pill_height, rndng, stroke_color, filclr);
              } else {
    ...
    Huviz.prototype.get_label_attributes = function(d) {
      var browser_font_size, bubble_text, focused_font_size, height, i, label_length, label_measure, line_height, line_length, ln_i, max_line_length, new_line_length, new_line_width, padding, real_line_length, text, text_cuts, text_split, width, width_default, word, word_length, _i, _len;
      text = d.pretty_name;
      label_measure = this.ctx.measureText(text);
      width_default = this.label_em * 200;
      ...
      return d.bub_txt = [width, height, line_height, text_cuts];
    };
    ...
    Huviz.prototype.draw_labels = function() {
      ...
      if (this.use_canvas || this.use_webgl) {
        ...
        label_node = (function(_this) {
          return function(node) {
            var adjust_x, adjust_y, alpha, cart_label, ctx, cuts, fill, flip, i, label, line_height, outline, pill_height, pill_width, print_label, radians, radius, text, textAlign, text_split, x, y, _i, _len;
    ...
    Huviz.prototype.get_container_width = function(pad) {
      pad = pad || hpad;
      this.width = (this.container.clientWidth || window.innerWidth || document.documentElement.clientWidth || document.clientWidth) - pad;
      return this.width = window.innerWidth - $("#tabs").width();
    };
