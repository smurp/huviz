...
(function() {
  ...
  UsernameWidget = (function(_super) {
    ...
    UsernameWidget.prototype.can_run = function() {
      var _ref;
      return (_ref = this.state) === 'good' || _ref === 'untried' || _ref === 'looking';
    };
    ...
    Huviz.prototype.discover_geoname_name = function(aUrl) {
      ...
      if ((widget = this.discover_geonames_as__widget)) {
        if (widget.state === 'untried') {
          ...
          if (this.discover_geonames_remaining < 1) {
            console.info('aborting discover_geoname_name() because remaining =', this.discover_geonames_remaining);
            return false;
          }
      ...
      $.ajax({
        ...
        success: (function(_this) {
          return function(json, textStatus, request) {
            var again, containershipQuad, deeperQuad, deeply, depth, geoNamesRoot, geoRec, greedily, key, msg, name, placeQuad, pred, quad, seen_name, soughtGeoname, subj, theType, value, _i, _ref, _ref1;
            if (json.status) {
            ...
            if ((widget = _this.discover_geonames_as__widget)) {
              if ((_ref = widget.state) === 'trying' || _ref === 'looking') {
