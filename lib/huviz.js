...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.ensure_datasets = function(preload) {
      var ds_rec, proto, _i, _len, _ref, _results;
      proto = preload.defaults || {};
    ...
    Huviz.prototype.fill_dataset_menus = function(why) {
      var count, make_onsuccess_handler, objectStore;
      if (this.args.preload) {
        HVZ.ensure_datasets(this.args.preload);
      }
        ...
        return function(why) {
          return function(event) {
            ...
            if (cursor) {
              ...
              return _this.update_dataset_ontology_loader();
            }
          };
        };
      })(this);
    ...
    Huviz.prototype.update_dataset_ontology_loader = function() {
      ...
      ds_on = "" + ds_v + " AND " + on_v;
      return this.big_go_button.prop('disabled', disable);
    };
  ...
  PickOrProvide = (function() {
    ...
    function PickOrProvide(huviz, append_to_sel, label, css_class, isOntology) {
      ...
      this.add_group({
        label: "-- Pick " + this.label + " --",
        id: this.pickable_uid
      });
      this.add_option({
    ...
    PickOrProvide.prototype.val = function(val) {
      return this.pick_or_provide_select.val(val);
    };
    ...
    PickOrProvide.prototype.add_uri = function(uri) {
      ...
      return this.add_dataset(dataset_rec);
    };
    ...
    PickOrProvide.prototype.add_option = function(opt_rec, parent_uid) {
      var k, opt, opt_str, _i, _j, _len, _len1, _ref, _ref1;
      ...
      return $(opt).data('canDelete', 'true');
    };
    ...
    PickOrProvide.prototype.find_or_append_form = function() {
      ...
      this.pick_or_provide_select.change((function(_this) {
        return function(e) {
          var canDelete, selected_option, value;
          e.stopPropagation();
          value = _this.pick_or_provide_select[0].value;
          console.log(_this.pick_or_provide_select.find('option:selected'));
          selected_option = _this.get_selected_option();
          if (value === 'provide') {
          ...
          if (_this.value != null) {
            ...
            canDelete = selected_option.data('canDelete') === 'true';
            _this.form.find('.delete_option').prop('disabled', !canDelete);
          }
    ...
    PickOrProvide.prototype.delete_selected_option = function(e) {
      ...
      if (val != null) {
        alert("deleting " + val);
        this.value = null;
        return this.delete_option(selected_option);
      }
    };
