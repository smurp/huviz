...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.build_sparql_form = function() {
      ...
      return this.endpoint_labels_JQElem.on('autocompleteselect', this.endpoint_labels_autocompleteselect);
    };

    Huviz.prototype.endpoint_labels_autocompleteselect = function(event) {
    ...
    function Huviz(incoming_args) {
      ...
      this.endpoint_labels_autocompleteselect = __bind(this.endpoint_labels_autocompleteselect, this);
