  ...
  Huviz = (function() {
    ...
    Huviz.prototype.disable_dataset_ontology_loader_AUTOMATICALLY = function() {
      ...
      endpoint = {
        ...
        label: this.endpoint_loader.value + " TODO - get label",
        limit: this.endpoint_limit_JQElem.val(),
        graph: {
          value: this.sparqlGraphSelector_JQElem.val(),
          label: this.sparqlGraphSelector_JQElem.val() + " TODO - get label"
        },
        item: {
          value: this.endpoint_labels_JQElem.val(),
          label: this.endpoint_labels_JQElem.val() + " TODO - get label"
        }
      };
