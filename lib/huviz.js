  ...
  Huviz = (function() {
    ...
    Huviz.prototype.render_node_info_box = function(info_node) {
      ...
      if (info_node) {
        ...
        this.make_dialog(node_info_html, this.unique_id(info_node.lid + '__'), dialogArgs);
      }
    };
    ...
    Huviz.prototype.hilight_window = function(window_id) {
      return console.log("hilight_window('" + window_id + "') by bringing it to top and doing a CSS trick");
    };
    ...
    Huviz.prototype.print_edge = function(edge) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (this.currently_printed_snippets[edge_inspector_id] != null) {
          this.hilight_window(edge_inspector_id);
          continue;
        }
        me = this;
