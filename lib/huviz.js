  ...
  Huviz = (function() {
    ...
    Huviz.prototype.make_tabs_html = function() {
      ...
      for (_i = 0, _len = tab_specs.length; _i < _len; _i++) {
        ...
        processor = (t.bodyUrl != null) && t.bodyUrl.endsWith('.md') && marked || function(data) {
          return data;
        };
        if (t.bodyUrl != null) {
          this.withUriDo(t.bodyUrl, idSel, processor);
        }
    ...
    Huviz.prototype.create_tabs = function() {
      ...
      if (!(position = this.args.create_tabs_adjacent_position)) {
