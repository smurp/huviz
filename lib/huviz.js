...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.draw_labels = function() {
      ...
      if (this.use_canvas || this.use_webgl) {
        ...
        label_node = (function(_this) {
          return function(node) {
            var cart_label, ctx, flip, label, radians, textAlign;
    ...
    Huviz.prototype.draw_cartouche = function(label, x, y) {
      var alpha, cart_color, height, outline, radius, width;
      ...
      return this.rounded_rectangle(x, y, width, height, radius, cart_color, outline, alpha);
    };
