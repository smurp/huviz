  ...
  EditController = (function() {
    function EditController(huviz) {
      ...
      if (this.userValid === true && !this.con) {
        ...
        this.con.innerHTML = "<div id='beta-note'>Beta</div><div class='cntrl-set slider-pair'><div class='label set-1'>VIEW</div><div class='slider'><div class='knob'></div></div><div class='label set-2'>EDIT</div></div>";
