...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.make_dialog = function(content_html, id, args) {
      ...
      $(elem.querySelector(' .close_node_details')).on('click', args.close || this.destroy_box);
      $(elem).draggable();
      return elem;
    };

    Huviz.prototype.destroy_box = function(e) {
      var box;
    ...
    Huviz.prototype.render_node_info_box = function() {
      var all_names, color, color_headers, dialogArgs, id_display, link_from, name, names_all_langs, node_info_html, node_out_links, node_type, note, other_types, target, target_prefix, width, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
      ...
      if (this.focused_node._colors) {
        ...
        _ref3 = this.focused_node._colors;
      ...
      if (this.focused_node) {
        ...
        this.make_dialog(node_info_html, this.unique_id(this.focused_node.lid + '__'), dialogArgs);
      }
    };
