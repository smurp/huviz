...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.update_labels_on_taxons = function() {
      var taxon_id, taxon_label, _ref, _results;
      _ref = this.ontology.label;
      _results = [];
      for (taxon_id in _ref) {
        taxon_label = _ref[taxon_id];
        _results.push(this.gclui.taxon_picker.id_to_name[taxon_id] = taxon_label);
      }
      return _results;
    };
