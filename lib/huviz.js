  ...
  Huviz = (function() {
    ...
    Huviz.prototype.on_change_language_path = function(new_val, old_val) {
      ...
      try {
        ...
        e = _error;
        alert("Submitted LANGPATH:\n  " + new_val + "\n\n" + (e.toString()) + "\n\nThe 'Language Path' should be a colon-separated list of ISO two-letter language codes, such as 'en' or 'fr:en:es'.  One can also include the keywords ANY, NOLANG or ALL in the list.\n\nANY means show a value from no particular language and NOLANG means show a value for which no language was specified. ANY works well in situations where you don't know or care which language is used.\n\nNOLANG is helpful for labels which don't have a language.\n\nALL causes all the different language versions to be revealed. It is best used alone\n\nExamples\n  en:fr\n  en:ANY:NOLANG\n  ALL\n");
