...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.set_setting = function(inputName, newVal) {
      var input;
    ...
    function Huviz(incoming_args) {
      ...
      this.init_settings_from_json = __bind(this.init_settings_from_json, this);
    ...
    Huviz.prototype.init_settings_from_json = function() {
        ...
        for (control_name in control_spec) {
          ...
          if (control.input != null) {
            if (control.input.type === 'select') {
              ...
              if (control.input.funct != null) {
                inputElem.setAttribute('funct', control.input.funct);
                $("button[funct='reset']").click(this.dump_current_settings);
              }
            } else {
    ...
    Huviz.prototype.apply_settings = function(settings) {
      ...
      for (setting in settings) {
        ...
        _results.push(this.set_setting(setting, value));
      }
      return _results;
    };
