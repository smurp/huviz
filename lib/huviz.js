...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.push_command_onto_future = function(cmd) {
      return this.future_cmds.push(cmd);
    };

    CommandController.prototype.push_future_onto_history = function() {
      var cmd, _i, _len, _ref;
      if (this.future_cmds.length) {
        this.huviz.goto_tab(3);
        _ref = this.future_cmds;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          cmd = _ref[_i];
          this.push_command_onto_history(cmd);
        }
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.walk__atLast = function() {
      ...
      wasRollCall = this.wasChosen_set.roll_call();
      nowRollCall = this.nowChosen_set.roll_call();
      current_selection = this.walked_latest_node;
      valid_path_nodes = [];
      active_nodes = [];
    ...
    Huviz.prototype.walk = function(walked) {
      console.log("walk(" + walked.lid + ")");
      this.walked_latest_node = walked;
      return this.choose(walked);
    };
    ...
    Huviz.prototype.visualize_dataset_using_ontology = function(ignoreEvent, dataset, ontologies) {
      ...
      alreadyCommands = this.gclui.future_cmds.length > 0;
    ...
    Huviz.prototype.show_future_commands = function() {
      alert('woot');
      return this.gclui.push_future_onto_history();
    };
    ...
    function Huviz(args) {
      ...
      this.show_future_commands = __bind(this.show_future_commands, this);
    ...
    Huviz.prototype.load_script_from_JSON = function(json) {
      var cmdArgs, saul_goodman, _i, _len, _results;
      saul_goodman = false;
      _results = [];
      for (_i = 0, _len = json.length; _i < _len; _i++) {
        cmdArgs = json[_i];
        if (__indexOf.call(cmdArgs.verbs, 'load') >= 0) {
          _results.push(saul_goodman = this.adjust_menus_from_load_cmd(cmdArgs));
        } else {
          _results.push(this.gclui.push_command_onto_future(this.gclui.new_GraphCommand(cmdArgs)));
        }
      }
      return _results;
    };
