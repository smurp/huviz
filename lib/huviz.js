...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.add_quad = function(quad, sprql_subj) {
      var cntx_n, ctxid, edge, isLiteral, is_type, literal_node, make_edge, newsubj, objId, objId_explanation, objKey, objVal, objValHasSpaces, obj_n, pred_n, pred_uri, simpleType, subj, subj_lid, subj_n, subj_uri, use_thumb;
      subj_uri = quad.s;
      pred_uri = quad.p;
