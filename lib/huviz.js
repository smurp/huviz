...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.auto_discover_name_for = function(uri) {
      var aUrl, comment, config, domainName, e, log_prefix, retval, _ref, _ref1;
      if (uri.startsWith('_')) {
        return;
      }
      try {
      ...
      _ref = this.ldf_domain_configs;
      for (domainName in _ref) {
        config = _ref[domainName];
        comment = "auto_discover_name_for(" + uri + ")";
        if (aUrl.hostname.includes(domainName)) {
          this.run_ldf_name_query(uri, null, comment, config);
        }
      }
      if (uri.startsWith("http://sws.geonames.org/") && ((_ref1 = this.discover_geonames_as__widget.state) === 'untried' || _ref1 === 'looking' || _ref1 === 'good') && this.discover_geonames_remaining > 0) {
    ...
    Huviz.prototype.run_managed_query_ldf = function(qry, url, args) {
      var error_callback, ldf_worker, queryManager, result_handler, sent, server_config, success_handler, timeout;
      if (args == null) {
        args = {};
      }
      if (args.worker == null) {
    ...
    Huviz.prototype.is_from_sparql = function() {
    ...
    Huviz.prototype.choose = function(chosen, callback_after_choosing) {
      ...
      if (this.is_from_sparql() && !chosen.fully_loaded) {
