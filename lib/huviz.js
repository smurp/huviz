...
(function(/*! Stitch !*/) {
  ...
  EditController = (function() {
    ...
    EditController.prototype.save_edit_form = function(value) {
    ...
    EditController.prototype.clear_edit_form = function(value) {
      var i, inputFields, _results;
      inputFields = this.parentElement.getElementsByTagName('input');
      _results = [];
      for (i in inputFields) {
        _results.push(this.parentElement.elements[i].value = '');
      }
      return _results;
    };
