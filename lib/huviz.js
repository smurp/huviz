...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.render_node_info_box = function() {
      var all_names, color, color_headers, dialogArgs, id_display, link_from, name, names_all_langs, node_info, node_out_links, node_type, note, other_types, target, target_prefix, width, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
...
(function() {
...
}, "verb/connect": function(exports, require, module) {(function() {
  var ConnectVerb, FiniteStateMachine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  FiniteStateMachine = require('fsm').FiniteStateMachine;

  ConnectVerb = (function(_super) {
    __extends(ConnectVerb, _super);

    ConnectVerb.prototype.throw_log_or_ignore = 'log';

    ConnectVerb.prototype.transitions = {
      start: {
        target: 'started'
      },
      pickSubj: {
    ...
    function ConnectVerb(huviz) {
      this.huviz = huviz;
      ConnectVerb.__super__.constructor.call(this);
    }
  ...
  (typeof exports !== "undefined" && exports !== null ? exports : this).ConnectVerb = ConnectVerb;
