...
(function() {
  ...
  CommandController = (function() {
    function CommandController(huviz, container, hierarchy) {
      ...
      this.on_play_click = __bind(this.on_play_click, this);
    ...
    CommandController.prototype.make_command_history = function() {
      ...
      this.scriptPlayButton = this.scriptPlayerControls.append('button').attr('title', 'play script step by step').attr('disabled', 'disabled').on('click', this.on_play_click);
      this.scriptPlayButton.append('i').attr("class", "fa fa-play");
      this.scriptForwardButton = this.scriptPlayerControls.append('button').attr('title', 'play script continuously').attr('disabled', 'disabled').attr('style', 'display:none').on('click', this.on_fastforward_click);
      this.scriptForwardButton.append('i').attr("class", "fa fa-forward");
      this.scriptDownloadButton = this.scriptPlayerControls.append('button').attr('title', 'save script').attr('style', 'margin-left:1em;display:none').on('click', this.on_downloadscript_clicked);
    ...
    CommandController.prototype.on_rewind_click = function() {
      ...
      this.reset_graph();
      return this.old_command_idx = 0;
    };

    CommandController.prototype.on_play_click = function() {
      this.play_old_command_by_idx(this.old_command_idx);
      return this.old_command_idx++;
    };

    CommandController.prototype.on_forward_click = function() {
      var cmdRecord, _i, _len, _ref;
      _ref = this.old_commands;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        cmdRecord = _ref[_i];
        this.play_old_command(cmdRecord.cmd);
        this.old_command_idx++;
      }
      this.scriptForwardButton.attr('disabled', 'disabled');
      return this.scriptPlayButton.attr('disabled', 'disabled');
    };

    CommandController.prototype.play_old_command_by_idx = function(idx) {
      var record;
      record = this.old_commands[idx];
    ...
    CommandController.prototype.push_command_onto_history = function(cmd) {
      ...
      cmd_ui = this.oldcommands.append('div').attr('class', 'played command');
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.draw_edges_from = function(node) {
      var draw_n_n, e, edge_width, edges_between, line_width, msg, n_n, num_edges, source_is_path, sway, target_is_path, _i, _len, _ref, _results;
        ...
        _results.push((function() {
          ...
          for (_j = 0, _len1 = edges_between.length; _j < _len1; _j++) {
            ...
            if (this.walk_path_set.length > 0) {
              ...
              for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
                node = _ref1[_k];
                if (e.source.lid === node) {
                  source_is_path = true;
                }
                if (e.target.lid === node) {
                  target_is_path = true;
                }
              }
            }
    ...
    Huviz.prototype.walk__atLast = function() {
      var active_nodes, connected_path, current_selection, e, edge, found_it, graphed_node, keep_graphed, keep_node, lid, node, node_lid, nowRollCall, old_node, remove, remove_list, removed, shownness, ungraphed, unique_keep, unique_remove, valid_path_nodes, wasRollCall, _i, _j, _k, _l, _len, _len1, _len10, _len11, _len12, _len13, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _results, _s, _t, _u, _v;
      wasRollCall = this.wasChosen_set.roll_call();
      nowRollCall = this.nowChosen_set.roll_call();
      _ref = this.nowChosen_set;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        node = _ref[_i];
        _ref1 = this.wasChosen_set;
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          old_node = _ref1[_j];
          if (node === old_node) {
            found_it = true;
      ...
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
        node = _ref2[_k];
        _ref3 = this.walk_path_set;
        for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
          lid = _ref3[_l];
          if (node.lid === lid) {
            active_nodes.push(node);
            _ref4 = node.links_from;
      ...
      for (_o = 0, _len6 = valid_path_nodes.length; _o < _len6; _o++) {
        node_lid = valid_path_nodes[_o];
      ...
      if (connected_path) {
        ...
        this.walk_path_set.sort();
        connected_path = false;
        if (this.prune_walk_nodes) {
          ungraphed = [];
          keep_graphed = [];
          for (_p = 0, _len7 = active_nodes.length; _p < _len7; _p++) {
            node = active_nodes[_p];
            keep_graphed.push(node);
            _ref6 = current_selection.links_shown;
          ...
          remove_list = [];
          _ref7 = this.graphed_set;
          for (_r = 0, _len9 = _ref7.length; _r < _len9; _r++) {
            graphed_node = _ref7[_r];
            remove = false;
            for (_s = 0, _len10 = unique_keep.length; _s < _len10; _s++) {
              keep_node = unique_keep[_s];
          ...
          _results = [];
          for (_t = 0, _len11 = remove_list.length; _t < _len11; _t++) {
            node = remove_list[_t];
            ...
            this.update_state(node);
            _results.push(shownness = this.update_showing_links(node));
          }
          return _results;
        }
      } else {
        ...
        for (_u = 0, _len12 = active_nodes.length; _u < _len12; _u++) {
          node = active_nodes[_u];
          removed.push(node);
        }
        for (_v = 0, _len13 = removed.length; _v < _len13; _v++) {
          node = removed[_v];
          this.unchoose(node);
          this.wasChosen_set.remove(node);
        }
        ...
        this.walk_path_set = [];
        return this.walk_path_set.push(current_selection.lid);
      }
    };
