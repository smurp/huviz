...
(function(/*! Stitch !*/) {
  ...
  EditController = (function() {
    ...
    EditController.prototype.set_predicate_selector = function(availableTags) {
    ...
    EditController.prototype.toggle_edit_form = function() {
      var predicate, predicates, toggleEditMode, _i, _len, _ref;
      ...
      if (toggleEditMode === 'no') {
        ...
        this.set_predicate_selector(predicates);
    ...
    EditController.prototype.predicate_is_DatatypeProperty = function() {
      ...
      if (this.predicate_input) {
        ...
        current_value = this.predicate_input.getAttribute('value');
