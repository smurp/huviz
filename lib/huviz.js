...
(function() {
  ...
  Huviz = (function() {
              ...
              if (state_at_start === 'trying' || state_at_start === 'looking') {
                ...
                if (widget.state === 'looking') {
                  if (_this.discover_geonames_remaining > 0) {
                    again = function() {
                      return _this.discover_names('sws.geonames.org');
                    };
    ...
    Huviz.prototype.auto_discover_name_for = function(uri) {
      ...
      if (hasDomainName("sws.geonames.org") && ((_ref = this.discover_geonames_as__widget.state) === 'untried' || _ref === 'looking' || _ref === 'good') && this.discover_geonames_remaining > 0) {
    ...
    Huviz.prototype.pfm_update = function() {
      var calls_per_second, class_count, item, k, marker, new_count, noE, noN, noOR, noP, old_count, pfm_marker, time, v, _ref, _results;
      time = Date.now();
      class_count = 0;
      if (this.nodes) {
