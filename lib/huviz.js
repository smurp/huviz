  ...
  Huviz = (function() {
    ...
    Huviz.prototype.clean_up_all_dirt_once = function() {
      if (this.clean_up_all_dirt_onceRunner == null) {
        this.clean_up_all_dirt_onceRunner = new OnceRunner(false);
      }
      return this.clean_up_all_dirt_onceRunner.setTimeout(this.clean_up_all_dirt, 500);
    };
    ...
    Huviz.prototype.prove_OnceRunner = function(timeout) {
      ...
      if (this.prove_OnceRunner_inst == null) {
        this.prove_OnceRunner_inst = new OnceRunner(true);
      }
      yahoo = function() {
        return alert('yahoo!');
      };
