...
(function(/*! Stitch !*/) {
  ...
  ColoredTreePicker = (function(_super) {
    ...
    ColoredTreePicker.prototype.collapse_by_id = function(id) {
      if (!this.is_leaf(id) && this.id_is_abstract[id]) {
        this.style_with_kid_color_summary(id);
      }
      return ColoredTreePicker.__super__.collapse_by_id.call(this, id);
    };
...
(function() {
  ...
  TreePicker = (function() {
    ...
    TreePicker.prototype.click_handler = function() {
      ...
      if (is_treepicker_collapsed && this.id_is_abstract[id]) {
