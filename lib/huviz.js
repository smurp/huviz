...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.walk__atLast = function() {
      var active_nodes, connected_path, current_selection, e, edge, found_it, graphed_node, keep_graphed, keep_it, keep_node, lid, node, node_lid, nowRollCall, old_node, prune_walk_nodes, removed, ungraphed, unique_keep, valid_path_nodes, wasRollCall, _i, _j, _k, _l, _len, _len1, _len10, _len11, _len12, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _s, _t, _u;
      wasRollCall = this.wasChosen_set.roll_call();
      nowRollCall = this.nowChosen_set.roll_call();
      ...
      console.log(this.walk_path_set);
      return console.log("================================");
    };
