...
(function() {
  ...
  UsernameWidget = (function() {
    UsernameWidget.prototype.state_to_fa_icon = {
      bad: 'fa-times',
      good: 'fa-check',
      maybe: 'fa-question'
    };

    function UsernameWidget(inputElem, state) {
      this.inputElem = inputElem;
      this.state = state;
      this.inputElem.insertAdjacentHTML('beforeend', "<span style=\"border:2px solid orange; color:orange; padding:2px\">\n  <i class=\"fa fa-user-alt\"></i>\n  <i class=\"fa fa-question\"></i>\n  <input style=\"border:none\"/>\n</span>");
    }
    ...
    UsernameWidget.prototype.set_state = function(state) {
      ...
      this.state = state;
      return this.state_to_fa_icon(state);
    };
      ...
      $.ajax({
        ...
        success: (function(_this) {
          return function(json, textStatus, request) {
            var containershipQuad, deep, deeperQuad, depth, geoNamesRoot, geoRec, greedy, key, msg, name, placeQuad, pred, quad, seen_name, soughtGeoname, subj, theType, value, _i, _ref;
            if (json.status) {
