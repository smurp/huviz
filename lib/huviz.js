...
(function(/*! Stitch !*/) {
  ...
  EditController = (function() {
    ...
    EditController.prototype.set_state = function(state) {
      this.state = state;
    };

    EditController.prototype.get_state = function() {
      return this.state;
    };
...
(function() {
  ...
  FiniteStateMachine = (function() {
    function FiniteStateMachine(id, transitions) {
      this.id = id;
    ...
    FiniteStateMachine.prototype.transit = function(trans_id) {
      var handler, targetState, transition;
      transition = this.transitions[trans_id];
      if (transition) {
        if ((handler = transition.handler)) {
          handler.call();
        } else {
          throw new Error("FiniteStateMachine " + this.id + " has no .handler");
        }
        if ((targetState = transition.targetState)) {
          this.setState(targetState);
        } else {
          throw new Error("FiniteStateMachine " + this.id + " has no .targetState");
        }
      } else {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.mousemove = function() {
      var action, cursor_text, d3_event, e, edge, edit_state, pair, the_node, _i, _len, _ref, _ref1, _ref2, _ref3;
