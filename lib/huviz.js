...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.on_change_show_queries_tab = function(new_val, old_val) {
      var JQElem, id, sel;
      if (this.sparqlQuery_tab_JQElem == null) {
        setTimeout(((function(_this) {
          return function() {
            return _this.on_change_show_queries_tab(new_val, old_val);
          };
        })(this)), 50);
        id = this.tabs_class_to_id['tabs-sparqlQueries'];
        if (!id) {
          console.log(this.tabs_class_to_id);
          console.error('can not find class');
          return;
        }
        sel = '[aria-controls="' + id + '"]';
        JQElem = this.tabsJQElem.find(sel);
        console.log(sel, JQElem.length);
        if (JQElem.length) {
          this.sparqlQuery_tab_JQElem = JQElem;
        } else {
          return;
        }
      }
      ...
      if (new_val) {
        return this.sparqlQuery_tab_JQElem.show();
      } else {
        return this.sparqlQuery_tab_JQElem.hide();
      }
    };
