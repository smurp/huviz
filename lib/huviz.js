...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.add_quad = function(quad) {
      var add_name, cntx_n, ctxid, edge, is_type, literal_node, make_edge, newsubj, obj_n, obj_val, pid, pred_n, sid, subj, subj_lid, subj_n;
      sid = quad.s;
      ...
      if (quad.o.type === RDF_object) {
        ...
        if (is_one_of(pid, NAME_SYNS)) {
          ...
          if (this.make_nodes_for_literals) {
            ...
            literal_node = this.get_or_create_node_by_id(quad.o.value);
