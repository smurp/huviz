...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.make_command_history = function() {
      ...
      this.scriptPlayerControls = history.append('div').attr('class', 'scriptPlayerControls').attr('style', 'position: relative; width: 50%;  float:right');
      this.scriptFastBackwardButton = this.scriptPlayerControls.append('button').append('i').attr("class", "fa fa-fast-backward").attr('title', 'go to start');
      this.scriptPlayButton = this.scriptPlayerControls.append('button').append('i').attr("class", "fa fa-play").attr('title', 'play script');
      this.scriptFastForwardButton = this.scriptPlayerControls.append('button').append('i').attr("class", "fa fa-fast-forward").attr('title', 'go to end');
      this.scriptDownloadButton = this.scriptPlayerControls.append('button').append('i').attr("class", "fa fa-file-download").attr('title', 'save script');
