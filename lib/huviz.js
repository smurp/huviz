...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.init_sets = function() {
      this.nodes = SortedSet().sort_on("id").named('All').labelled('ALL');
      ...
      this.chosen_set = SortedSet().named("chosen").labelled('CHOSEN').isFlag().sort_on("id");
      ...
      this.selected_set = SortedSet().named("selected").labelled('SELECTED').isFlag().sort_on("id");
      ...
      this.shelved_set = SortedSet().sort_on("name").named("shelved").labelled('SHELVED').isState();
      this.shelved_set.docs = "Nodes which are '" + this.shelved_set.label + "' on the green surrounding 'shelf'.";
      this.discarded_set = SortedSet().sort_on("name").named("discarded").labelled('DISCARDED').isState();
      ...
      this.hidden_set = SortedSet().sort_on("id").named("hidden").labelled('HIDDEN').isState();
      ...
      this.graphed_set = SortedSet().sort_on("id").named("graphed").labelled('GRAPHED').isState();
      this.graphed_set.docs = "Nodes which are included in the central graph.";
      this.graphed_set.cleanup_verb = "unchoose";
      this.pinned_set = SortedSet().sort_on("id").named('fixed').labelled('PINNED').isFlag();
      ...
      this.labelled_set = SortedSet().named("labelled").labelled('LABELLED').isFlag().sort_on("id");
