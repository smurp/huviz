...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.query_and_show = function(url, id, callback) {
      var ajax_settings, qry;
      qry = "SELECT ?g\nWHERE {\n  GRAPH ?g { }\n}";
      ajax_settings = {
        'type': 'POST',
        'url': url,
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(data, textStatus, jqXHR) {
            var graph, graph_options, graph_select, json_check, json_data, results, _i, _len;
            ...
            graph_select = "<div id='sparqlGraphSelect' class=ui-widget style=''>\n<label for='endpoint_labels'>Graphs: </label>\n<select id=''>\n    " + graph_options + "\n</select>\n</div>";
            return $("#" + id).after(graph_select);
          };
        })(this),
        error: (function(_this) {
          return function(jqxhr, textStatus, errorThrown) {
    ...
    Huviz.prototype.load_endpoint_data_and_show = function(url, callback) {
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(data, textStatus, jqXHR) {
            var disable, endpoint, json_data;
            json_data = JSON.parse(data);
    ...
    Huviz.prototype.add_nodes_from_SPARQL = function(json_data, subject) {
      var context, data, language, new_pred, new_subj, node, nodes_in_data, obj_type, obj_val, plainLiteral, q, _i, _len, _results;
      data = '';
      context = "http://universal.org";
    ...
    Huviz.prototype.walk = function(chosen) {
      var prev, previouslyChosen, _i, _j, _len, _len1, _ref;
      previouslyChosen = [];
      ...
      this.choose(chosen);
      for (_j = 0, _len1 = previouslyChosen.length; _j < _len1; _j++) {
        prev = previouslyChosen[_j];
        if (prev !== chosen) {
          this.unchoose(prev);
        }
      }
    ...
    Huviz.prototype.update_endpoint_form = function(e) {
      ...
      this.query_and_show(e.currentTarget.value, e.currentTarget.id);
    ...
    Huviz.prototype.populate_label_picker = function(labels) {
      var searchHint, select_box, spinner;
      searchHint = "";
      ...
      return $("#endpoint_labels").autocomplete({
        ...
        source: (function(_this) {
          return function(request, response) {
            ...
            console.log(_this.endpoint_loader);
            ajax_settings = {
              'type': 'POST',
              'url': url,
              'data': qry,
    ...
    function Huviz(args) {
      ...
      this.query_and_show = __bind(this.query_and_show, this);
