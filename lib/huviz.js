...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.add_quad = function(quad) {
      var add_name, cntx_n, ctxid, edge, is_type, literal_node, make_edge, newsubj, objId, objKey, objVal, obj_n, pid, pred_n, safe_quad_o_value, sid, simpleType, subj, subj_lid, subj_n;
      sid = quad.s;
      ...
      edge = null;
      subj_n = this.get_or_create_node_by_id(subj_lid);
      ...
      if (quad.o.type === RDF_object) {
        obj_n = this.get_or_create_node_by_id(safe_quad_o_value);
        ...
        if (is_type) {
          this.try_to_set_node_type(subj_n, safe_quad_o_value);
        }
        if (make_edge) {
          this.develop(subj_n);
    ...
    Huviz.prototype.get_or_create_node_by_id = function(sid, name) {
      var node, node_id;
      node_id = this.make_qname(sid);
