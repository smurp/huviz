...
(function() {
  ...
  var TokenStream = function(input) {
    ...
    var verbs = " " +
        ...
        "Wander Walk " +
        "Draw ";
    var connectors = " every except regarding ";
    ...
    function is_set(x) {
      return sets.indexOf(" " + x + " ") >= 0;
    }
    function is_verb(x) {
      return verbs.indexOf(" " + x + " ") >= 0;
    }
    function is_connector(x) {
      return connectors.indexOf(" " + x + " ") >= 0;
    }
    ...
    function is_whitespace(ch) {
      // How is the + sign in the URL version being handled.
      return " \t\n".indexOf(ch) >= 0;
    }
