...
(function() {
  ...
  Huviz = (function() {
      ...
      $.ajax({
        ...
        success: (function(_this) {
          return function(json, textStatus, request) {
            var containershipQuad, deeperQuad, deeply, depth, geoNamesRoot, geoRec, greedily, key, msg, name, placeQuad, pred, quad, seen_name, soughtGeoname, subj, theType, value, _i, _ref;
            if (json.status) {
    ...
    Huviz.prototype.auto_discover = function(uri) {
      ...
      if (uri.startsWith("http://sws.geonames.org/") && this.discover_geonames_as__widget.can_run() && this.discover_geonames_remaining) {
