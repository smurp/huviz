...
(function() {
  ...
  CommandController = (function() {
    function CommandController(huviz, container, hierarchy) {
      ...
      this.effect_on_predicate_clicked = __bind(this.effect_on_predicate_clicked, this);
    ...
    CommandController.prototype.on_predicate_clicked = function(pred_id, new_state, elem) {
      ...
      return setTimeout((function(_this) {
        return function() {
          return _this.effect_on_predicate_clicked(pred_id, new_state, elem);
        };
      })(this));
    };

    CommandController.prototype.effect_on_predicate_clicked = function(pred_id, new_state, elem) {
      var cmd, verb;
