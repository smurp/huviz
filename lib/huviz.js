...
(function(/*! Stitch !*/) {
  ...
  Edge = (function() {
    ...
    Edge.prototype.show = function() {
      this.predicate.shown_instances.acquire(this);
      if (this.isSelected()) {
        this.predicate.select(this);
      } else {
        this.predicate.unshown_instances.remove(this);
        this.predicate.unselect(this);
      }
      return this.predicate.update(this, {
        show: true
      });
    };
    ...
    Edge.prototype.unshow = function() {
      if (this.isSelected()) {
        this.predicate.unshown_instances.acquire(this);
        this.predicate.select(this);
      } else {
        this.predicate.unshown_instances.acquire(this);
        this.predicate.unselected_instances.acquire(this);
      }
      return this.predicate.update(this, {
        show: false
      });
...
(function() {
  ...
  Predicate = (function(_super) {
    ...
    Predicate.prototype.update = function(inst, change) {
      if (change.show != null) {
        if (change.show) {
          this.shown_instances.acquire(inst);
        } else {
          this.unshown_instances.acquire(inst);
        }
      }
      if (change.select != null) {
        if (change.select) {
          this.selected_instances.acquire(inst);
        } else {
          this.unselected_instances.acquire(inst);
        }
      }
      return this.update_state(inst, change);
    };
    ...
    Predicate.prototype.update_state = function() {
      this.update_selected_instances();
      return Predicate.__super__.update_state.call(this);
    };
  ...
  Taxon = (function(_super) {
    ...
    Taxon.prototype.update_node = function(node, change) {
      if (change.select != null) {
        if (change.select) {
          this.selected_instances.acquire(node);
        } else {
          this.unselected_instances.acquire(node);
        }
      }
      if (change.discard != null) {
        this.discarded_instances.acquire(node);
      }
      return this.update_state();
    };
...
(function() {
  ...
  TreeCtrl = (function() {
    ...
    TreeCtrl.prototype.select = function(inst) {
      this.update(inst, {
        select: true
      });
      return this.update_state();
    ...
    TreeCtrl.prototype.unselect = function(inst) {
      this.update(inst, {
        select: false
      });
      return this.update_state();
    ...
    TreeCtrl.prototype.update_state = function() {
...
(function() {
  ...
  TreePicker = (function() {
    ...
    TreePicker.prototype.click_handler = function() {
      var elem, id, is_treepicker_collapsed, is_treepicker_indirect_mixed, is_treepicker_showing, listener, new_state, parent_id, picker, send_leafward, suspend_listener, this_id;
