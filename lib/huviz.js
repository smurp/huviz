...
(function() {
  ...
  Huviz = (function() {
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(data, textStatus, jqXHR) {
            ...
            return console.log("Finished request: count now " + _this.endpoint_loader.outstanding_requests);
          };
        })(this),
        error: (function(_this) {
          return function(jqxhr, textStatus, errorThrown) {
    ...
    Huviz.prototype.add_nodes_from_SPARQL = function(json_data, subject) {
      var context, data, language, node, node_list_empty, node_not_in_list, nodes_in_data, obj_type, obj_val, plainLiteral, pred, q, snode, subj, _i, _j, _len, _len1, _ref, _results;
      data = '';
      context = "http://universal.org";
