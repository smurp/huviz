...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.update_boxNG = function(node) {
      ...
      elem = node.boxNG;
      this.move_boxNG_if_needed(node, elem);
      jqElem = $(elem);
    ...
    Huviz.prototype.move_boxNG_if_needed = function(node, elem) {
    ...
    Huviz.prototype.style_boxNG_jqElem = function(node, jqElem) {
      var css;
      css = {};
      css['color'] = node.color;
      css['font-size'] = this.label_em + 'em';
      css['z-index'] = 0;
      jqElem.css(css);
    };

    Huviz.prototype.focus_boxNG_jqElem = function(node, jqElem) {
      var css;
      jqElem.addClass('focusedNode');
      css = {};
      css['color'] = node.color;
      css['font-size'] = (this.label_em * this.focused_mag) + 'em';
      css['z-index'] = 10000;
      jqElem.css(css);
    };
