...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.render_node_info_box = function() {
      var all_names, color, color_headers, dialogArgs, id_display, link_from, name, names_all_langs, node_info, node_out_links, node_type, note, other_types, target, width, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2;
      ...
      if (this.focused_node.links_from.length > 0) {
        ...
        for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
          link_from = _ref1[_k];
          target = this.create_link_if_url(link_from.target.id);
    ...
    Huviz.prototype.sparql_graph_query_and_show = function(url, id, callback) {
      ...
      $("#sparqlQryInput_" + this.sparqlId).css('display', 'none');
    ...
    Huviz.prototype.populate_graphs_selector = function(request, response) {
      ...
      spinner = $("#endpoint_labels_" + this.sparqlId).siblings('i');
