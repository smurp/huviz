...
(function() {
  ...
  CommandController = (function() {
    function CommandController(huviz, container, hierarchy) {
      ...
      this.build_setpicker("Sets");
      this.build_taxon_picker("Classes");
      this.likediv = this.comdiv.append('div');
      this.add_clear_both(this.comdiv);
      this.build_predicatepicker("Edges of the Selected Nodes");
      this.init_editor_data();
      this.build_form();
      this.update_command();
      this.install_listeners();
      this.immediate_execution_mode = false;
    }
    ...
    CommandController.prototype.build_predicatepicker = function(label) {
      var id, where;
      id = 'predicates';
    ...
    CommandController.prototype.build_taxon_picker = function(label) {
      var id, where;
      id = 'classes';
      where = (label != null) && this.control_label(label) || this.comdiv;
      ...
      return this.taxon_picker.show_tree(this.hierarchy, this.taxon_box);
    };
    ...
    CommandController.prototype.on_taxon_clicked = function(id, new_state, elem) {
      var class_name, cmd, old_state, taxon;
    ...
    CommandController.prototype.update_command = function() {
      ...
      if (ready && this.immediate_execution_mode) {
        this.command.execute(this.huviz);
      }
    ...
    CommandController.prototype.build_setpicker = function(label) {
      var where;
      where = (label != null) && this.control_label(label) || this.comdiv;
      this.the_sets = {
        'nodes': [
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.mousemove = function() {
      ...
      if (this.dragging) {
        ...
        this.text_cursor.set_text("drop to " + action);
      }
    ...
    Huviz.prototype.init_sets = function() {
      ...
      this.pinned_set = SortedSet().sort_on("id").named('fixed', 'pinned').isFlag();
      this.pinned_set.docs = "Nodes which are pinned to the canvas";
    ...
    Huviz.prototype.find_focused_node_or_edge = function() {
      ...
      return this.focused_edge = new_focused_edge;
    };
    ...
    Huviz.prototype.set_cursor_for_verbs = function(verbs) {
      var i, label, one_line, pointer, text, verb, _i, _j, _len, _len1;
      ...
      if (verbs.length > 0) {
        if (one_line) {
          ...
          for (_i = 0, _len = verbs.length; _i < _len; _i++) {
            verb = verbs[_i];
            pointer += "" + this.gclui.verb_cursors[verb];
          }
          label = angliciser(verbs);
          text = "" + pointer + " " + label;
        } else {
          text = "";
          for (i = _j = 0, _len1 = verbs.length; _j < _len1; i = ++_j) {
            verb = verbs[i];
            if (i > 0) {
              text += "\n";
            }
            text += "" + this.gclui.verb_cursors[verb] + " " + verb;
          }
        }
      } else {
        text = "";
    ...
    Huviz.prototype.clean_up_dirty_predicates = function() {
      return this.predicate_set.get_by('id', 'anything').clean_up_dirt();
    };
    ...
    function Huviz() {
      ...
      if (this.use_fancy_cursor) {
        this.text_cursor = new TextCursor("#viscanvas", "");
  ...
  TextCursor = (function() {
    TextCursor.prototype.fillStyle = "black";
    ...
    TextCursor.prototype.set_text = function(text) {
      var cursor, url;
      if (text) {
    ...
    TextCursor.prototype.pause = function(cursor) {
      this.paused = true;
      return this.set_cursor(cursor);
    };
    ...
    TextCursor.prototype.make_img = function(text) {
      var cursor, i, id, inset, line, lines, sel, top, url, voffset, _i, _len;
      ...
      inset = 4;
      top = 10;
      this.draw_bubble(inset, top, this.width - inset, this.height - top, 12);
    ...
    TextCursor.prototype.draw_bubble = function(x, y, w, h, radius) {
...
(function() {
  ...
  TreePicker = (function() {
    ...
    TreePicker.prototype.click_handler = function() {
      var elem, id, is_treepicker_collapsed, is_treepicker_indirect_showing, is_treepicker_showing, listener, new_state, parent_id, picker, send_leafward, this_id;
