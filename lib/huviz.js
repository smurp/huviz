...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.is_immediate_mode = function() {
      return this.engaged_verbs.length > 0 && this.is_command_object_empty;
    };
    ...
    CommandController.prototype.build_submit = function() {
      this.doit_butt = this.nextcommand.append('span').append("input").attr("style", "float:right;display:none;").attr("type", "submit").attr('value', 'Do it').attr('id', 'doit_button');
