...
(function() {
  ...
  Huviz = (function() {
      ...
      return parser.parse(data, (function(_this) {
        return function(err, quad, pref) {
          ...
          if (quadTester(quad)) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              aQuad = _ref[_i];
              _results.push(_this.add_quad(aQuad));
            }
            return _results;
          }
        };
    ...
    Huviz.prototype.discover_labels = function(uri) {
      var aUrl, discoArgs;
      aUrl = new URL(uri);
      discoArgs = {
    ...
    Huviz.prototype.auto_discover = function(uri) {
      if (uri.startsWith("http://id.loc.gov/")) {
        return this.ingest_quads_from("" + uri + ".skos.nt", this.discover_labels(uri));
      }
    };
