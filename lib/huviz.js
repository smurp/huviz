...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.auto_discover_name_for = function(uri) {
      var aUrl, comment, config, domainName, downloadUrl, e, hasDomainName, retval, try_even_though_CORS_should_block, _ref, _ref1;
      if (uri.startsWith('_')) {
        return;
      }
      try {
      ...
      if (hasDomainName("vocab.getty.edu") && try_even_though_CORS_should_block) {
    ...
    Huviz.prototype.make_ldf_name_query = function(uri) {
      return "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\nPREFIX foaf: <http://xmlns.com/foaf/0.1/>\nPREFIX schema: <http://schema.org/>\nSELECT *\nWHERE {\n  {\n    BIND (foaf:name as ?p) .\n    <" + uri + "> ?p ?o .\n  } UNION {\n    BIND (rdfs:label as ?p) .\n    <" + uri + "> ?p ?o .\n  } UNION {\n    BIND (schema:name as ?p) .\n    <" + uri + "> ?p ?o .\n  }\n}\nLIMIT 100";
    };

    Huviz.prototype.convert_N3_to_GreenTurtle = function(n3_obj_term) {
    ...
    Huviz.prototype.ldf_name_result_handler = function(result, queryManager) {
      var q, spo;
      if ((spo = true)) {
        q = {
          s: result['?s'] || queryManager.args.default_terms.s,
          p: result['?p'] || queryManager.args.default_terms.p,
          o: this.convert_N3_to_GreenTurtle(result['?o'])
        };
    ...
    Huviz.prototype.run_ldf_name_query = function(uri, expansion, comment, server_config) {
      var args, query, sparql;
      sparql = this.make_ldf_name_query(uri, expansion);
      comment = "# " + (comment || ("run_ldf_name_query(" + uri + ")")) + "\n";
      query = comment + sparql;
      args = {
        result_handler: this.ldf_name_result_handler,
    ...
    Huviz.prototype.run_sparql_name_query = function(uri, expansion, comment) {
      var args, handler, query, sparql, _ref;
    ...
    Huviz.prototype.run_managed_query_ajax = function(qry, url, args) {
    ...
    Huviz.prototype.run_managed_query_worker = function(qry, url, args) {
      var queryManager;
      queryManager = this.run_managed_query_abstract(qry, url, args);
      return queryManager;
    };
    ...
    function Huviz(incoming_args) {
      ...
      this.ldf_name_result_handler = __bind(this.ldf_name_result_handler, this);
