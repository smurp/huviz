...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.respect_single_chosen_node = function() {
      var chosen_node, cmd, pinned_node, _i, _len, _ref, _results;
      if (!this.single_chosen) {
        return;
      }
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if ((pinned_node.pinned_only_while_chosen != null) && (!pinned_node.chosen || this.chosen_set.length !== 1)) {
          _results.push(this.unpin(pinned_node));
        } else {
          _results.push(void 0);
        }
      }
    ...
    Huviz.prototype.init_settings_from_json = function() {
      ...
      this.settings_JQElem.append("<div class='buffer_space'></div>");
    };
