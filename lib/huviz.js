...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.run_ldf_name_query = function(uri, expansion, comment, serverUri) {
      var args, query;
    ...
    Huviz.prototype.run_managed_query_ldf = function(qry, url, args) {
      var error_callback, ldf_worker, queryManager, result_handler, serverUri, success_handler, timeout;
      if (args == null) {
        args = {};
      }
      if (args.worker == null) {
      ...
      success_handler = args.success_handler, error_callback = args.error_callback, timeout = args.timeout, result_handler = args.result_handler, serverUri = args.serverUri;
      if (serverUri == null) {
