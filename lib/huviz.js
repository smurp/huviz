...
(function(/*! Stitch !*/) {
  ...
  EditController = (function(_super) {
    ...
    function EditController(huviz) {
      ...
      this.show_form = __bind(this.show_form, this);
      this.hide_form = __bind(this.hide_form, this);
      this.update_predicate_picked = __bind(this.update_predicate_picked, this);
      this.show_verbs = __bind(this.show_verbs, this);
      this.hide_verbs = __bind(this.hide_verbs, this);
      this.ensure_verbs = __bind(this.ensure_verbs, this);
      this.add_verbs = __bind(this.add_verbs, this);
      this.get_verb_set = __bind(this.get_verb_set, this);
      this.on__enable = __bind(this.on__enable, this);
      this.on__disable = __bind(this.on__disable, this);
      this.on__prepare = __bind(this.on__prepare, this);
      this.userValid = true;
      this.ensure_verbs();
    ...
    EditController.prototype.show_form = function() {
      ...
      return this.huviz.set_edit_mode(true);
    };
  ...
  FiniteStateMachine = (function() {
    ...
    FiniteStateMachine.prototype.get_transit_handler_name = function(transit_id) {
      return 'on__' + transit_id;
    };

    FiniteStateMachine.prototype.transit = function(trans_id) {
      var before_state_name, called, msg, target_id, transit_handler, transit_handler_name, transition;
      if (this.transitions == null) {
        this.transitions = {};
      }
      called = false;
      if ((transition = this.transitions[trans_id])) {
        transit_handler_name = this.get_transit_handler_name(trans_id);
        ...
        if (!called) {
          msg = "FiniteStateMachine " + (this.id || '') + " had neither " + transit_handler_name + " or " + before_state_name;
          console.log(this);
          throw new Error(msg);
        }
      } else {
        throw new Error("FiniteStateMachine " + (this.id || '') + " has no transition with id " + trans_id);
      }
    };
...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.render_node_info_box = function() {
      var all_names, color, color_headers, dialogArgs, link_from, name, names_all_langs, node_info, node_out_links, node_type, note, other_types, target, url_check, width, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2;
    ...
    Huviz.prototype.show_geonames_instructions = function() {
      var args, markdown;
      args = {
    ...
    Huviz.prototype.auto_discover_name_for = function(uri) {
      ...
      if (uri.startsWith("http://sws.geonames.org/") && ((_ref = this.discover_geonames_as__widget.state) === 'untried' || _ref === 'looking' || _ref === 'good') && this.discover_geonames_remaining > 0) {
    ...
    Huviz.prototype.get_or_create_node_by_id = function(uri, name, isLiteral) {
      ...
      if (node.name == null) {
        if (name == null) {
          name = this.ontology.label[node.lid] || node.lid;
        }
    ...
    Huviz.prototype.get_or_create_transient_node = function(subjNode, point) {
      var isLiteral, name, transient_id, transient_node;
      transient_id = '_:_transient';
      transient_node = this.get_or_create_node_by_id(transient_id, (name = "↪"), (isLiteral = false));
    ...
    Huviz.prototype.populate_sparql_label_picker = function() {
      var fromGraph, select_box, sparqlId, spinner;
      sparqlId = unique_id();
      ...
      fromGraph = '';
      return $(".endpoint_labels_" + sparqlId).autocomplete({
        minLength: 3,
        delay: 500,
        position: {
          collision: "flip"
    ...
    Huviz.prototype.init_settings_from_json = function() {
      ...
      this.insertBeforeEnd(this.settingsElem, "<div class=\"buffer_space\"></div>");
    };
    ...
    Huviz.prototype.on_change_discover_geonames_remaining = function(new_val, old_val) {
      this.discover_geonames_remaining = new_val;
