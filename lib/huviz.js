...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.make_boxNG = function(node) {
      var div;
      div = this.addDivWithIdAndClasses(null, "boxNG", this.viscanvas_elem);
      div.innerHTML = node.pretty_name;
      div.onmousedown = (function(_this) {
        return function(evt) {
      ...
      div.onmouseenter = (function(_this) {
        return function(evt) {
          return _this.mouseenter_boxNG(evt, node);
        };
      })(this);
      div.onmouseup = (function(_this) {
        return function(evt) {
