...
(function() {
  ...
  var CommandController, DC_subject, DragAndDropLoader, Edge, FOAF_Group, FOAF_Person, FOAF_name, GraphCommandLanguageCtrl, GreenerTurtle, Huviz, MANY_SPACES_REGEX, NAME_SYNS, Node, OWL_Class, OWL_ObjectProperty, OWL_Thing, OntoViz, OntologicallyGrounded, Orlando, PEEKING_COLOR, PickOrProvide, Predicate, RDFS_label, RDF_a, RDF_literal, RDF_object, RDF_type, Socrata, TYPE_SYNS, Taxon, TextCursor, UNDEFINED, XML_TAG_REGEX, angliciser, default_node_radius_policy, dist_lt, distance, gcl, has_predicate_value, has_type, hpad, id_escape, ids_to_show, is_a_main_node, is_node_to_always_show, is_one_of, linearize, node_radius_policies, start_with_http, unescape_unicode, uniquer, wpad,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Huviz = (function() {
      ...
      if (!this.datasetDB && indexedDB) {
        ...
        request.onsuccess = (function(_this) {
          return function(e) {
            ...
            db = request.result;
            _this.datasetDB = db;
            return _this.fill_dataset_menus();
          };
        })(this);
        ...
        request.onsuccess = (function(_this) {
          return function(e) {
            _this.datasetDB = event.target.result;
            return _this.datasetDB.onerror = function(e) {
    ...
    Huviz.prototype.add_dataset = function(dataset_rec, callback) {
      var req, store, trx;
      trx = this.datasetDB.transaction('datasets', "readwrite");
      trx.oncomplete = (function(_this) {
        return function(e) {
          return alert("" + dataset_rec.uri + " added!");
        };
      })(this);
    ...
    Huviz.prototype.fill_dataset_menus = function() {};

    Huviz.prototype.init_dataset_menus = function() {
      var sel;
      if (!this.dataset_loader && this.args.dataset_loader__append_to_sel) {
        this.dataset_loader = new PickOrProvide(this, this.args.dataset_loader__append_to_sel, 'Dataset:', false);
      }
      if (!this.ontology_loader && this.args.ontology_loader__append_to_sel) {
        this.ontology_loader = new PickOrProvide(this, this.args.ontology_loader__append_to_sel, 'Ontology:', true);
      }
      if (!this.big_go_button) {
        $(this.args.ontology_loader__append_to_sel).append('<button>GO</button>');
        sel = "" + this.args.ontology_loader__append_to_sel + " > button";
        console.log(sel);
        this.big_go_button = $(sel);
      }
  ...
  PickOrProvide = (function() {
    ...
    PickOrProvide.prototype.add_uri = function(uri) {
      var dataset, label;
      ...
      return this.huviz.add_dataset(dataset, this.add_dataset_option);
    };

    PickOrProvide.prototype.add_dataset_option = function(dataset) {
      var uri;
      uri = dataset.uri;
      this.pick_or_provide_select.append("<option value=\"" + uri + "\">" + label + "</option>");
      return this.pick_or_provide_select.val(uri);
    };

    PickOrProvide.prototype.find_or_append_form = function() {
      if (!$(this.local_file_form_sel).length) {
        $(this.append_to_sel).append(this.tmpl.replace('REPLACE_WITH_LABEL', this.label));
      }
      this.form = $("" + this.append_to_sel + " .pick_or_provide_form");
      this.pick_or_provide_select = this.form.find("select[name='pick_or_provide']");
      this.pick_or_provide_select.change((function(_this) {
        return function(e) {
          var value;
          e.stopPropagation();
          value = _this.pick_or_provide_select[0].value;
          if (value === 'provide') {
            _this.drag_and_drop_loader.form.show();
            _this.state = 'awaiting_dnd';
          } else {
            _this.drag_and_drop_loader.form.hide();
            _this.state = 'has_value';
            _this.value = value;
          }
          return _this.huviz.update_dataset_ontology_loader();
        };
      })(this));
  ...
  DragAndDropLoader = (function() {
    ...
    DragAndDropLoader.prototype.local_file_form_sel = '.local_file_form';
    ...
    DragAndDropLoader.prototype.find_or_append_form = function() {
      ...
      return this.form.on('drop', (function(_this) {
        return function(e) {
          ...
          return _this.form.find('.box__input').show();
        };
      })(this));
    };
