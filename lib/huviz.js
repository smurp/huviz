...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.mouseup = function() {
      ...
      if (this.dragging) {
        ...
        if (this.in_discard_dropzone(this.dragging)) {
          ...
          if (this.edit_mode && this.dragging === this.editui.subject_node && false) {
    ...
    Huviz.prototype.find_node_or_edge_closest_to_pointer = function() {
      var closest_dist, closest_point, focus_threshold, new_focused_edge, new_focused_idx, new_focused_node, node_changed, seeking, svg_node;
      ...
      if (seeking === 'focused_node') {
        node_changed = this.focused_node !== new_focused_node;
    ...
    Huviz.prototype.add_remote_datasets = function() {
      var data_set, preload_group, recs, _i, _j, _len, _len1, _ref;
      ...
      if (this.args.preload) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          preload_group = _ref[_i];
          console.log(preload_group);
          this.ensure_datasets(preload_group);
          for (_j = 0, _len1 = preload_group.length; _j < _len1; _j++) {
            data_set = preload_group[_j];
            console.log(data_set);
            recs.push(data_set);
            if (data_set.isOntology) {
              if (this.ontology_loader) {
                console.log("== Now ontology loader ==");
                this.ontology_loader.add_dataset_option(data_set);
              }
            } else {
              if (this.dataset_loader) {
                console.log("== Now dataset loader ==");
                this.dataset_loader.add_dataset_option(data_set);
              }
            }
          }
        }
  ...
  PickOrProvide = (function() {
    ...
    PickOrProvide.prototype.add_group = function(grp_rec, which) {
      ...
      if (which === 'prepend') {
        optgrp = this.pick_or_provide_select.prepend(optgroup_str);
        return console.log(optgrp);
      } else {
    ...
    PickOrProvide.prototype.update_state = function(callback) {
      ...
      console.log("PickOrProvide:", this, "select:", this.pick_or_provide_select[0].value);
