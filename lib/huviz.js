...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.convert_json_to_ttl = function(raw_json_data, subject) {
      var data, new_line, node, nodes_in_data, object_print, type_print, _i, _len;
      data = '';
    ...
    Huviz.prototype.populate_label_picker = function(labels) {
      ...
      searchHint = "<br><p style='font-size:.8em;margin-top:5px;color: #999;margin-left: 40px;'>Put a space in front to retrieve word</p>";
