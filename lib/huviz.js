...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.draw_nodes = function() {
      ...
      if (this.use_canvas || this.use_webgl) {
        return this.graphed_set.forEach((function(_this) {
          return function(d, i) {
            var filclr, img, img_url, node_radius, pill_height, pill_width, rndng, special_focus, stroke_color, x, y;
            ...
            if (_this.use_canvas) {
              ...
              } else if (_this.show_images_in_nodes && (img_url = d.__thumbnail || _this.default_node_url)) {
                img = _this.get_or_create_round_img(img_url);
    ...
    Huviz.prototype.get_or_create_round_img = function(url) {
      var ctx, display_image_size, img, imgId, round_image_maker, theImage;
      ...
      if (!(img = this.round_img_cache[url])) {
        ...
        this.addHTML("<img id=\"" + imgId + "\" src=\"" + url + "\" xstyle=\"display:none\"/>");
        ...
        theImage.onload = function() {
          ...
          ctx.drawImage(theImage, x, y, w, h);
          return img.src = round_image_maker.toDataURL();
        };
    ...
    Huviz.prototype.init_settings_from_json = function() {
      var a, control, control_name, control_spec, graph_control, input, k, label, old_val, option, settings_input_sel, v, value, _i, _len, _ref, _ref1, _ref2;
