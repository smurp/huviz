...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.run_sparql_name_query = function(namelessUri, args, comment) {
      var defaults, serverUri;
      if (args == null) {
        args = {};
      }
      if (args.query == null) {
        args.query = "# " + (comment || ("run_sparql_name_query(" + namelessUri + ")")) + "\n" + this.make_name_query(namelessUri, args);
      }
      defaults = {
      ...
      return this.run_managed_query_ajax(args.query, serverUri, args);
    };
    ...
    Huviz.prototype.name_result_handler = function(result, queryManager) {
      var error, obj_term, parseObj, parseUri, pred_term, q, result_type, subj_term;
      subj_term = result['?s'] || result['s'] || queryManager.args.default_terms.s;
      pred_term = result['?p'] || result['p'] || queryManager.args.default_terms.p;
      obj_term = result['?o'] || result['o'];
