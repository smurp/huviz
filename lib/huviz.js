  ...
  Huviz = (function() {
    ...
    Huviz.prototype.get_data_ontology_display_id = function() {
      if (this.data_ontology_display_id == null) {
        this.data_ontology_display_id = unique_id();
      }
    ...
    Huviz.prototype.make_tabs_html = function() {
      var ctrl_handle_id, firstClass, id, idSel, mkcb, t, tab_specs, theDivs, theHandles, theTabs, _i, _len;
      ...
      for (_i = 0, _len = tab_specs.length; _i < _len; _i++) {
        ...
        if (firstClass === 'huvis_controls' && false) {
    ...
    Huviz.prototype.create_tabs = function() {
      ...
      this.addHTML(this.make_tabs_html());
    };
    ...
    Huviz.prototype.make_JQElems = function() {
      var found, jqelem_id, key, sel, _i, _len, _ref;
    ...
    Huviz.prototype.calculate_args = function(incoming_args) {
      ...
      args = Object.assign(this.default_args, incoming_args);
    ...
    function Huviz(incoming_args) {
      ...
      this.maximize_gclui = __bind(this.maximize_gclui, this);
      this.minimize_gclui = __bind(this.minimize_gclui, this);
