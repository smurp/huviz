...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.get_next_snippet_position_obj = function() {
      return this.snippet_position_str_to_obj(this.get_next_snippet_position());
    };
  ...
  Orlando = (function(_super) {
    ...
    Orlando.prototype.push_snippet = function(msg_or_obj) {
      ...
      pos = this.get_next_snippet_position_obj();
      dialogArgs = {
        width: this.width,
        height: this.height,
        ...
        close: (function(_this) {
          return function(event, ui) {
            return alert('closing ' + event.target.id);
          };
        })(this)
      };
