...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.make_tabs_html = function() {
      var firstClass, id, idSel, mkcb, t, tab_specs, theDivs, theHandles, theTabs, _i, _len;
      ...
      theTabs += "</ul>";
      this.tabs_id = unique_id('tabs_');
      return ["<section id=\"" + this.tabs_id + "\" class=\"huviz_tabs\" role=\"controls\">", theHandles, theTabs, theDivs, "</section>"].join('');
    };
    ...
    function Huviz(args) {
      ...
      this.tabsJQElem.on('click', '#blurt_close', this.close_blurt_box);
