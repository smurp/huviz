...
(function() {
  ...
  Huviz = (function() {
    var nodeOrderAngle, nodeOrderClockwise, renderStyles;
    ...
    Huviz.prototype.init_sets = function() {
      ...
      this.shelved_set = SortedSet().named("shelved").case_insensitive_sort(true).labelled(this.human_term.shelved).sub_of(this.all_set).isState();
      ...
      this.discarded_set = SortedSet().named("discarded").labelled(this.human_term.discarded).case_insensitive_sort(true).sub_of(this.all_set).isState();
    ...
    Huviz.prototype.add_quad = function(quad) {
      var cntx_n, ctxid, edge, is_type, newsubj, obj_n, pid, pred_n, sid, subj, subj_lid, subj_n;
      sid = quad.s;
    ...
    Huviz.prototype.on_change_choose_node_display_order = function(new_val) {
      if (new_val) {
        nodeOrderClockwise = true;
      } else {
