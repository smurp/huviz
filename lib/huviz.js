...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.init_sets = function() {
      ...
      this.walked_set = SortedSet().named("walked").isFlag().sub_of(this.chosen_set).sort_on('walkedIdx0');
    ...
    Huviz.prototype.draw_nodes = function() {
      ...
      if (this.use_canvas || this.use_webgl) {
        return this.graphed_set.forEach((function(_this) {
          return function(d, i) {
            var filclr, node_radius, pill_height, pill_width, rndng, special_focus, stroke_color, x, y;
    ...
    Huviz.prototype.walk = function(nextStep) {
      ...
      if (tooHairy) {
        this.shave(tooHairy);
        this.update_state(tooHairy);
      }
      if (!this.walked_set.is_sorted()) {
        debugger;
      }
    };
      ...
      for (_i = _ref.length - 1; _i >= 0; _i += -1) {
        ...
        if (link != null) {
          ...
          if (!this.edgeIsOnWalkedPath(link)) {
            _results.push(this.unshow_link(link));
          } else {
            _results.push(void 0);
          }
        } else {
          _results.push(console.log("there is a null in the .links_shown of", unchosen));
        }
      }
      return _results;
    };
    ...
    Huviz.prototype.load_script_from_JSON = function(json) {
      ...
      for (_i = 0, _len = json.length; _i < _len; _i++) {
        ...
        if (__indexOf.call(cmdArgs.verbs, 'load') >= 0) {
          ...
          _results.push(this.gclui.push_cmdArgs_onto_future(cmdArgs));
        }
      }
      return _results;
    };
