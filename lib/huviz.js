...
(function() {
  ...
  var BASE10, BASE57, CommandController, DC_subject, DragAndDropLoader, Edge, EditController, FOAF_Group, FOAF_Person, FOAF_name, GraphCommandLanguageCtrl, GreenerTurtle, Huviz, IndexedDBService, IndexedDBStorageController, MANY_SPACES_REGEX, NAME_SYNS, Node, OWL_Class, OWL_ObjectProperty, OWL_Thing, OntoViz, OntologicallyGrounded, Orlando, PEEKING_COLOR, PickOrProvide, Predicate, RDFS_label, RDF_a, RDF_literal, RDF_object, RDF_type, Socrata, TYPE_SYNS, Taxon, TextCursor, UNDEFINED, XML_TAG_REGEX, angliciser, convert, default_node_radius_policy, dist_lt, distance, escapeHtml, gcl, has_predicate_value, has_type, hash, hpad, id_escape, ids_to_show, int_to_base, is_a_main_node, is_node_to_always_show, is_one_of, linearize, node_radius_policies, orlando_human_term, start_with_http, synthIdFor, tau, themeStyles, unescape_unicode, unique_id, uniquer, wpad,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.add_quad = function(quad) {
      var add_name, cntx_n, ctxid, edge, is_type, literal_node, make_edge, newsubj, objId, objKey, objVal, obj_n, pid, pred_n, sid, subj, subj_lid, subj_n;
      sid = quad.s;
      ...
      if (quad.o.type === RDF_object) {
        ...
        if (is_one_of(pid, NAME_SYNS)) {
          ...
          if (this.make_nodes_for_literals) {
            objVal = quad.o.value;
            if (quad.o.lang || (objVal.match(/\s/g) || []).length > 0) {
            ...
            this.try_to_set_node_type(literal_node, "Thing");
    ...
    Huviz.prototype.predicates_to_ignore = ["anything", "comment", "first", "rest", "members"];
