...
(function(/*! Stitch !*/) {
  ...
  EditController = (function() {
    function EditController(huviz) {
      ...
      this.set_edit_for_dataProperty = __bind(this.set_edit_for_dataProperty, this);
    ...
    EditController.prototype.create_edit_form = function(toggleEdit) {
      ...
      availableTags = ["ActionScript", "AppleScript", "Asp", "BASIC", "C", "C++", "Clojure", "COBOL", "ColdFusion", "DatatypeProperty: literal string", "DatatypeProperty: number", "DatatypeProperty: date", "Erlang", "Fortran", "Groovy", "Haskell", "Java", "JavaScript", "Lisp", "Perl", "PHP", "Python", "Ruby", "Scala", "Scheme"];
    ...
    EditController.prototype.validate_edit_form = function(evt) {
      ...
      return console.log(form.elements[1].value);
    };

    EditController.prototype.adjust_object_type = function() {
      var placeholder_label, typeDatatypeProperty, typePropertyType;
      typeDatatypeProperty = true;
      typePropertyType = "DatatypeProperty";
      placeholder_label = "Object (DatatypeProperty)";
      if (typeDatatypeProperty) {
        this.set_edit_for_dataProperty();
        return $(form.elements[2]).attr("placeholder", placeholder_label);
      } else {
        return this.dataPropertyNoDrag = false;
      }
    };

    EditController.prototype.set_edit_for_dataProperty = function() {
      console.log("set_edit_for_dataProperty");
      return this.dataPropertyNoDrag = true;
    };
      ...
      if (this.dragging) {
        ...
        if (this.edit_mode) {
          if (this.editui.object_node || !this.editui.subject_node) {
            if (this.editui.dataPropertyNoDrag) {
