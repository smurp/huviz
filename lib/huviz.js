...
(function() {
  ...
  PickOrProvide = (function() {
    ...
    PickOrProvide.prototype.add_dataset_option = function(dataset) {
      ...
      console.log(this.pick_or_provide_select);
      return this.refresh();
    };
    ...
    PickOrProvide.prototype.update_state = function(callback) {
      var canDelete, disable_the_delete_button, kid_cnt, raw_value, selected_option, the_options;
