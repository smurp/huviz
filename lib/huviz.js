...
(function() {
  ...
  Huviz = (function() {
    ...
    function Huviz(args) {
      ...
      var msg, search_input, timerId;
      this.pfm_dashboard('startup');
      timerId = setInterval(this.pfm_update, 1000);
      if (args == null) {
        args = {};
      }
    ...
    Huviz.prototype.on_change_show_hide_performance_monitor = function(new_val, old_val) {
      ...
      if (new_val) {
        return $("#performance_dashboard").css('display', 'block');
      } else {
        return $("#performance_dashboard").css('display', 'none');
      }
    };
    ...
    Huviz.prototype.pfm_update = function() {
      ...
      for (pfm_marker in this.pfm_data) {
        ...
        calls_per_second = new_count - old_count + 0.001;
        if (this.pfm_data["" + pfm_marker]["timed_count"]) {
          ...
          this.pfm_data["" + pfm_marker].prev_total_count = new_count;
