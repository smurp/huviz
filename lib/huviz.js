  ...
  This method is intended to replace D3 constructions like:
   ...
   with
       ...
       const exp = append_html_to(
           ...
           domElem);
*/
function append_html_to$1(html, elem) {
...
class TreePicker {
  ...
  get_or_create_container(contents) {
    ...
    return append_html_to$1(`<div class="container"></div>`, contents);
  }
  get_top() {
...
class ColoredTreePicker extends TreePicker {
  ...
  update_css() {
    if ((this.style_sheet == null)) {
      this.style_sheet = append_html_to$1(`<style></style>`, this.elem);
    }
