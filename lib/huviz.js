...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.find_node_or_edge_closest_to_pointer = function() {
      var closest, closest_point, edge_changed, focus_threshold, last_focused_edge, last_focused_node, new_focused_edge, new_focused_idx, new_focused_node, node_changed, obj_type, q, seeking, svg_node;
      ...
      if (seeking === 'object_node') {
        if (this.editui.object_node !== this.object_node) {
          ...
          if (this.object_node.id) {
            this.add_quad(q);
            this.show_links_from_node(this.focused_node);
          }
        }
      }
