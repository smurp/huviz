...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.make_tabs_html = function() {
      var firstClass, id, idSel, mkcb, t, tab_specs, theDivs, theTabs, _i, _len;
      ...
      return ["<section id=\"" + this.tabs_id + "\" class=\"huviz_tabs\" role=\"controls\">", theTabs, theDivs, "</section>"].join('');
    };
