...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.init_indexddbstorage = function() {
      return this.dbsstorage != null ? this.dbsstorage : this.dbsstorage = new IndexedDBStorageController(this);
    };
  ...
  IndexedDBService = (function() {
    ...
    IndexedDBService.prototype.initialize_db = function() {
      var indexedDB, req;
      ...
      if (!this.nstoreDB && indexedDB) {
        ...
        return req.onupgradeneeded = (function(_this) {
          return function(evt) {
            var db, store;
            ...
            if (evt.oldVersion < 3) {
              alert("createObjectStore('" + _this.dbObjectStoreName + "')");
