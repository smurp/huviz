...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.get_or_create_node_by_id = function(uri, name) {
      ...
      if (node.name == null) {
        this.set_name(node, name || node.lid);
      }
      return node;
    };
