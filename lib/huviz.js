...
(function() {
  ...
  CommandController = (function() {
    function CommandController(huviz, container, hierarchy) {
      ...
      this.execute_command = __bind(this.execute_command, this);
    ...
    CommandController.prototype.update_command = function(because) {
      ...
      if (ready && this.huviz.doit_asap && this.immediate_execution_mode && !this.is_proposed()) {
        this.execute_command(because);
      }
      return this.huviz.hide_state_msg();
    };

    CommandController.prototype.execute_command = function(because) {
      var start;
  ...
  GraphCommand = (function() {
    ...
    GraphCommand.prototype.execute = function() {
      var errorHandler, iter, meth, nodes, reg_req, _i, _j, _len, _len1, _ref, _ref1;
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.init_sets = function() {
      ...
      this.nameless_set = SortedSet().named("nameless").sort_on("nameless_since").isFlag();
    ...
    Huviz.prototype.inject_discovered_quad_for = function(quad, url) {
      ...
      return console.log("inject_discovered_quad(" + (JSON.stringify(quad)) + ")");
    };

    Huviz.prototype.auto_discover = function(uri) {
      var aUrl;
      aUrl = new URL(uri);
    ...
    Huviz.prototype.remove_from_nameless = function(node) {
      ...
      return this.nameless_set.remove(node);
    };
    ...
    Huviz.prototype.add_to_nameless = function(node) {
      ...
      this.nameless_set.push(node);
      if (this.nameless_set.length > 1) {
        return colorlog("nameless count: " + this.nameless_set.length, "darkgreen");
      }
    };
    ...
    Huviz.prototype.query_and_show = function(url, callback) {
      var qry, queryUrl;
    ...
    Huviz.prototype.load_endpoint_data_and_show = function(url, callback) {
      var node_limit, qry, queryUrl, subject;
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(data, textStatus, jqXHR) {
            var data_ttl, disable, endpoint;
            data_ttl = _this.convert_json_to_ttl(data, subject);
            _this.parseAndShowTTLData(data_ttl);
            endpoint = _this.endpoint_loader.value;
            _this.dataset_loader.disable();
            _this.ontology_loader.disable();
            _this.replace_loader_display_for_endpoint(endpoint, subject);
            disable = true;
            _this.update_go_button(disable);
            return _this.big_go_button.hide();
          };
        })(this),
        error: (function(_this) {
          return function(jqxhr, textStatus, errorThrown) {
    ...
    Huviz.prototype.convert_json_to_ttl = function(raw_json_data, subject) {
      var data, new_line, node, nodes_in_data, obj, object_print, sub, type_print, _i, _len;
      data = '';
    ...
    Huviz.prototype.clean_up_all_dirt = function() {
      ...
      return setTimeout(this.clean_up_dirty_predictes, 500);
    };
    ...
    Huviz.prototype.visualize_dataset_using_ontology = function(ignoreEvent, dataset, ontologies) {
      ...
      if (endpoint_label_uri) {
        ...
        this.update_caption(data.value, "Endpoint Defined");
        return;
      }
    ...
    Huviz.prototype.update_endpoint_form = function(e) {
      return $('#sparqlQryInput').css('display', 'block');
    };
    ...
    Huviz.prototype.replace_loader_display_for_endpoint = function(endpoint, query) {
      var data_ontol_display;
      $("#huvis_controls .unselectable").attr("style", "display:none");
          ...
          return function(request, response) {
            ...
            return $.ajax({
              ...
              success: function(data, textStatus, jqXHR) {
                var label, results, selections, this_result, _i, _len;
    ...
    function Huviz(args) {
      ...
      this.populate_label_picker = __bind(this.populate_label_picker, this);
  ...
  OntologicallyGrounded = (function(_super) {
    ...
    OntologicallyGrounded.prototype.read_ontology = function(ontology_uri) {
      return $.ajax({
        ...
        error: function(jqxhr, textStatus, errorThrown) {
          return this.show_state_msg(errorThrown + " while fetching ontology " + ontology_uri);
        }
      });
    };
    ...
    Orlando.prototype.push_snippet = function(msg_or_obj) {
      ...
      if (this.snippet_box) {
        if (typeof msg_or_obj !== 'string') {
          ...
          msg_or_obj = "<div id=\"" + obj.snippet_js_key + "\">\n  <dl style=\"font-size:" + this.snippet_triple_em + "em\">\n    <dt>subject <span style=\"background-color:" + m.edge.source.color + "\">&cir;</span></dt><dd>" + (this.make_link(obj.quad.subj_uri)) + "</dd>\n    <dt>predicate <span style=\"background-color:" + m.edge.color + "\">&xrarr;</span></dt><dd>" + (this.make_link(obj.quad.pred_uri)) + "</dd>\n    <dt>object <span style=\"background-color:" + m.edge.target.color + "\">&cir;</span></dt>" + obj_dd + "\n    <dt>graph</dt><dd>" + (this.make_link(obj.quad.graph_uri)) + "</dd>\n  </dl>\n</div>\n";
        }
