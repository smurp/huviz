...
(function() {
  ...
  CommandController = (function() {
    ...
    CommandController.prototype.make_command_history = function() {
      ...
      this.scriptForwardButton = this.scriptPlayerControls.append('button').attr('title', 'play script continuously').attr('disabled', 'disabled').attr('display', 'none').on('click', this.on_fastforward_click);
      this.scriptForwardButton.append('i').attr("class", "fa fa-forward");
      this.scriptDownloadButton = this.scriptPlayerControls.append('button').attr('title', 'save script').attr('style', 'margin-left:1em').attr('display', 'none').on('click', this.on_downloadscript_clicked);
