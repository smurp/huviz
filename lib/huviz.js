...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.use_quadtree = function() {
      return !this.show_edges;
    };

    Huviz.prototype.update_quadtree_if_needed = function() {
      var i, n, q, _results;
      ...
      _results = [];
      while (++i < n) {
        _results.push(q.visit(this.collide(this.graphed_set[i])));
      }
      return _results;
    };

    Huviz.prototype.collide = function(node) {
    ...
    Huviz.prototype.tick = function(msg) {
      ...
      this.update_quadtree_if_needed();
