...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.euthanize_populate_graphs_selector = function() {
      if (this.populate_graphs_selector_queryManager != null) {
        this.populate_graphs_selector_queryManager.kill();
        return true;
      }
      return false;
    };
    ...
    Huviz.prototype.populate_graphs_selector = function(request, response) {
      ...
      this.euthanize_populate_graphs_selector();
      ...
      return this.populate_graphs_selector_queryManager = this.run_managed_query_ajax(qry, url, args);
    };
