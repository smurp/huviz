...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.test_load_endpoint_data_and_show = function(subject, callback) {
      var ajax_settings, fromGraph, node_limit, qry, url;
      node_limit = $('#endpoint_limit').val();
      url = this.endpoint_loader.value;
      fromGraph = '';
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(data, textStatus, jqXHR) {
            ...
            return _this.add_nodes_from_SPARQL(json_data, subject);
          };
        })(this),
        error: (function(_this) {
          return function(jqxhr, textStatus, errorThrown) {
    ...
    Huviz.prototype.choose = function(chosen) {
      ...
      if (this.endpoint_loader.value) {
        if (!chosen.fully_loaded) {
          ...
          this.test_load_endpoint_data_and_show(chosen.id);
        }
      }
    ...
    Huviz.prototype.load_data_with_onto = function(data, onto, callback) {
      ...
      if (data.isEndpoint) {
        console.log("++++++++++++++++++++++++++++++++++++++++++++++++++");
        this.query_and_show(this.data_uri, callback);
        return;
      }
