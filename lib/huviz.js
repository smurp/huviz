...
(function() {
  ...
  Huviz = (function() {
    ...
    Huviz.prototype.auto_discover_name_for = function(uri) {
      var aUrl, args, domainName, downloadUrl, e, hasDomainName, retval, serverUri, try_even_though_CORS_should_block, _ref, _ref1;
      if (uri.startsWith('_')) {
        return;
      }
      try {
      ...
      for (domainName in _ref1) {
        serverUri = _ref1[domainName];
        args = {
          serverUri: serverUri
        };
        if (domainName === '*') {
          this.run_ldf_name_query(uri, args);
          return;
    ...
    Huviz.prototype.run_sparql_name_query = function(namelessUri, args) {
      var defaults;
      if (args == null) {
        args = {};
      }
      ...
      return this.run_managed_query_ajax(args.query, args.serverUri, args);
    };
    ...
    Huviz.prototype.run_ldf_name_query = function(namelessUri, args) {
      var defaults;
      if (args == null) {
        args = {};
      }
      ...
      args = this.compose_object_from_defaults_and_incoming(defaults, args);
      return this.run_managed_query_ldf(args.query, args.serverUri, args);
    };
