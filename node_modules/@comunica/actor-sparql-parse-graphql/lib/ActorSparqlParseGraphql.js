...
const ActorInitSparql_browser_1 = require("@comunica/actor-init-sparql/lib/ActorInitSparql-browser");
...
class ActorSparqlParseGraphql extends bus_sparql_parse_1.ActorSparqlParse {
    ...
    async run(action) {
        ...
        const options = {
            singularizeVariables: action.context.get(ActorInitSparql_browser_1.KEY_CONTEXT_GRAPHQL_SINGULARIZEVARIABLES),
        };
