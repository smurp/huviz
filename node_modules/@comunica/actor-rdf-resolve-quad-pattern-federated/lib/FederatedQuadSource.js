...
class FederatedQuadSource {
    ...
    matchLazy(subject, predicate, object, graph) {
        ...
        const it = new asynciterator_union_1.RoundRobinUnionIterator(sourcesIt.map((source) => {
            ...
            const pattern = data_model_1.quad(FederatedQuadSource.nullToVariable(subject, 's'), FederatedQuadSource.nullToVariable(predicate, 'p'), FederatedQuadSource.nullToVariable(object, 'o'), FederatedQuadSource.nullToVariable(graph, 'g'));
